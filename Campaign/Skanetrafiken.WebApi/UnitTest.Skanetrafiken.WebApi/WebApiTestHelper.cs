...
namespace Endeavor.Crm.UnitTest
{
    class WebApiTestHelper
    {
        ...
        public static string WebApiRootEndpoint = @"https://crm.endeavor.se:8096/api/";              // ED Utv med token
        ...
        //public static readonly string WebApiRootEndpoint = @"http://localhost:37909/api/";                    // Egen maskin
