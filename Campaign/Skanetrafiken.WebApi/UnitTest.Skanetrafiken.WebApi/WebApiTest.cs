...
namespace Endeavor.Crm.UnitTest
{
    ...
    public class WebApiTest : PluginFixtureBase
    {
        ...
        //        var httpWebRequest = (HttpWebRequest)WebRequest.Create(string.Format("{0}{1}", WebApiRootEndpoint, "CreateCustomerLead"));
        ...
        //        var httpWebRequest = (HttpWebRequest)WebRequest.Create(string.Format("{0}{1}", WebApiRootEndpoint, "ChangeEmailAddress"));
        //        httpWebRequest.ContentType = "application/json";
        //        httpWebRequest.Method = "POST";
        //        #endregion
        ...
        //        var httpWebRequest = (HttpWebRequest)WebRequest.Create(string.Format("{0}{1}", WebApiRootEndpoint, "UpdateContact"));
        //        httpWebRequest.ContentType = "application/json";
        //        httpWebRequest.Method = "POST";
        //        #endregion
        ...
        //        string url = string.Format(@"{0}{1}?contactGuidOrEmail={2}", WebApiRootEndpoint, "GetContact", "95FCAD0E-50FD-E411-80D8-005056903A38");
        ...
        public void WebApiUtilTest()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    //{
                    //    string url1 = $"{WebApiRootEndpoint}contacts";
                    //    var httpWebRequest1 = (HttpWebRequest)WebRequest.Create(url1);
                    //    CreateTokenForTest(localContext, httpWebRequest1);
                    ...
                    //}
                    //{
                    //    string url2 = $"{WebApiRootEndpoint}leads";
                    //    var httpWebRequest2 = (HttpWebRequest)WebRequest.Create(url2);
                    //    CreateTokenForTest(localContext, httpWebRequest2);
                    ...
                    //string linkGuid;
                    //{
                    //    string url = $"{WebApiRootEndpoint}leads/GetLatestLinkGuid/{creatingAccountInfo.Email}/";
                    //    var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
                    //    CreateTokenForTest(localContext, httpWebRequest);
                    //    httpWebRequest.ContentType = "application/json";
                    //    httpWebRequest.Method = "GET";
                    ...
                    //{
                    //    string url = $"{WebApiRootEndpoint}leads/{linkGuid}";
                    //    var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
                    //    CreateTokenForTest(localContext, httpWebRequest, Guid.Parse(creatingAccountInfo.Guid));
                    //    httpWebRequest.ContentType = "application/json";
                    ...
                    {
                        //string url = string.Format(@"{0}{1}/12/12", WebApiRootEndpoint, "leads");
                        //string url = string.Format(@"{0}{1}/226b9907-46bb-45c4-b1ae-f5a29bf17641", WebApiRootEndpoint, "leads");
                        ...
                        //using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        //{
                        //    //CustomerInfo faultyInfo = InvalidCustomerInfo_SkapaKonto_InvalidMailAddress;
                        //    //faultyInfo.Source = (int)CustomerUtility.Source.SkapaMittKonto;
                        //    string InputJSON = SerializeCustomerInfo(localContext, new CustomerInfo()
                        //    {
                        //        Guid = "226b9907-46bb-45c4-b1ae-f5a29bf17641",
                        //        Email = "xxx",
                        //        Source = 1
                        //    });
                        //    InputJSON = "{\"guid\":\"226b9907-46bb-45c4-b1ae-f5a29bf17641\",\"email\":\"xxx\",\"source\":1}";
        ...
        //            var httpWebRequest = (HttpWebRequest)WebRequest.Create(string.Format("{0}{1}", WebApiRootEndpoint, "leads"));
        //            httpWebRequest.ContentType = "application/json";
        //            httpWebRequest.Method = "POST";
        ...
        //        try
        //        {
        //            CustomerInfo customer = ValidCustomerInfo_FullTest(GetUnitTestID());
        ...
        //            try
        //            {
        //                var httpWebRequest = (HttpWebRequest)WebRequest.Create($"{WebApiRootEndpoint}contacts/{secondContact.Id.ToString()}");
        //                CreateTokenForTest(localContext, httpWebRequest, secondContact.Id);
        //                httpWebRequest.ContentType = "application/json";
        //                httpWebRequest.Method = "PUT";
                ...
                try
                {
                    ...
                    #region NotifyMKL
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            ...
                            string InputJSON = WebApiTestHelper.SerializeNotificationInfo(localContext, notificationInfo);
        ...
        //            var httpWebRequest = (HttpWebRequest)WebRequest.Create(string.Format("{0}{1}/", WebApiRootEndpoint, "contacts"));
        //            httpWebRequest.ContentType = "application/json";
        //            httpWebRequest.Method = "PUT";
        ...
        //        {
        //            #region CreateCustomerLead
        //            var httpWebRequest = (HttpWebRequest)WebRequest.Create($"{WebApiRootEndpoint}contacts/21e926e4-31a7-e611-8112-00155d0a6b01");
        //            httpWebRequest.ContentType = "application/json";
        //            httpWebRequest.Method = "PUT";
        ...
        //            //string url = string.Format(@"{0}{1}/{2}", WebApiRootEndpoint, "leads", "ValidateEmail");
        //            string url = string.Format(@"{0}{1}/{2}", WebApiRootEndpoint, "contacts", "ValidateEmail");
        //            var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
        //            httpWebRequest.ContentType = "application/json";
        //            httpWebRequest.Method = "PUT";
        ...
        //        {
        //            #region GetContact
        //            //string url = string.Format(@"{0}{1}?contactGuidOrEmail={2}", WebApiRootEndpoint, "GetContact", ValidCustomerInfo_SkapaKonto1.Email);
        //            string url = string.Format(@"{0}contacts/{1}/", WebApiRootEndpoint, "email-100003@example.com");
        //            //string url = string.Format(@"{0}{1}?contactGuidOrEmail={2}", WebApiRootEndpoint, "GetContact", "73ABE25F-58FD-E411-80D8-005056903A38");
        //            var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
        //            httpWebRequest.ContentType = "application/json";
        //            httpWebRequest.Method = "GET";
        ...
        //        string url = string.Format(@"{0}{1}?customerId={2}&entityTypeCode={3}&eMailAddress={4}", WebApiRootEndpoint, "ValidateEmail", "95FCAD0E-50FD-E411-80D8-005056903A38", ContactEntity.EntityTypeCode, "testaddress@example.com");
        //        var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
        //        httpWebRequest.ContentType = "application/json";
        //        httpWebRequest.Method = "GET";
        //        #endregion
