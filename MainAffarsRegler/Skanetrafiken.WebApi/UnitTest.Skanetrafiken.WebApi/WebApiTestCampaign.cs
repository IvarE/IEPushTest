    ...
    public class WebApiTestCampaign : PluginFixtureBase
    {
        ...
        public void KeepCampaignLeadsSeperate()
        {
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    CustomerInfo customer = WebApiTest.Generate_ValidCustomerInfoObject(testInstanceName);
                    ...
                    customer.SwedishSocialSecurityNumberSpecified = true;
        ...
        public void QualifyLead_CopyAdressToContact()
        {
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                // Are we updating the addresses? Mobile and Email are the same
