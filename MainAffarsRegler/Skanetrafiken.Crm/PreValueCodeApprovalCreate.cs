...
{
    public class PreValueCodeApprovalCreate : Plugin
    {
        public PreValueCodeApprovalCreate()
            : base(typeof(PreValueCodeApprovalCreate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(20, "Create", ValueCodeApprovalEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteValueCodeApprovalCreate)));
        ...
        /// </remarks>
        protected void PreExecuteValueCodeApprovalCreate(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    ValueCodeApprovalEntity.HandlePreValueCodeApprovalCreate(localContext, target);
                }
                catch (Exception ex)
                {
