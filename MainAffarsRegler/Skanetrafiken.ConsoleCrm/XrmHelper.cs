...
{
    /// <summary>
    /// The XrmHelper class simplifies the retrieval, update and create of records in Crm 2011.
    /// </summary>
    public static class XrmHelper
    {
        ...
        public static String ParseCrmTypesToString(Entity Entity, String CrmAttributeName, String FormatString = "", bool IfOptionSetOrEntityRefReturnKeyNotName = false)
        {
            ...
            if (CrmAttribute != null)
            {
                ...
                {
                    throw new NotImplementedException("Party lists are not implemented (yet) in Constructor.Crm.Coesia.Plugin.Helpers.XrmHelper.ParseCrmTypesToString");
                }
            }
            return Value;
        }
