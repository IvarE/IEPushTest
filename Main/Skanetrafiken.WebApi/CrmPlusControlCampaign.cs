...
namespace Skanetrafiken.Crm.Controllers
{
    public class CrmPlusControlCampaign : CrmPlusControl
    {
        ...
        internal static HttpResponseMessage RetrieveLeadInfo(int threadId, string campaignCode)
        {
            try
            {
        ...
        internal static HttpResponseMessage QualifyLeadToUnvalidatedCustomer(int threadId, LeadInfo leadInfo)
        {
            try
            {
                CrmServiceClient serviceClient = ConnectionCacheManager.GetAvailableConnection(threadId, true);
        ...
        internal static HttpResponseMessage PostLeadAndQualifyToContact(int threadId, LeadInfo leadInfo)
        {
            if (leadInfo == null)
            {
