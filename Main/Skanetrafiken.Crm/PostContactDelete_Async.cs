...
{
    public class PostContactDelete_Async : Plugin
    {
        /// <summary>
        /// </summary>
        private readonly string preImageAlias = "preImage";

        public PostContactDelete_Async()
            : base(typeof(PostContactDelete_Async))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Delete, ContactEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteContactDeleteAsync)));
        ...
        /// </remarks>
        protected void PostExecuteContactDeleteAsync(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    preImage.HandlePostContactDeleteAsync(localContext, target);
                }
                catch (Exception ex)
                {
