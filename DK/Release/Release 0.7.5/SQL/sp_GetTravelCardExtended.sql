...
BEGIN
	...
	left outer join DKCRM_MSCRM.dbo.FilteredContact contact on travelcard.cgi_contactid = contact.contactid
	left outer join DKCRM_MSCRM.dbo.FilteredAccount account on travelcard.cgi_accountid = account.accountid
