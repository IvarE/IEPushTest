    ...
    public class CreateCaseManager
    {
            ...
            out string errorMessage)
        {
            ...
            else
            {
                isContactOrAccountInCrm =
                    ...
                    || TryGetContactBySocialSecurityNumber(request.SocialSecurityNumber, out contact)
                    || TryGetContactByNameAndAddress(request.FirstName, request.LastName, request.Address_Line1, request.Address_PostalCode, request.Address_City, out contact);
            }
        ...
        private Guid CreateContact(AutoRgCaseRequest request)
        {
            ...
            if (!string.IsNullOrEmpty(request.MobileNo))
                contactEntity.Attributes.Add("telephone3", request.MobileNo);
            ...
            if (!string.IsNullOrEmpty(request.Address_Line2))
                contactEntity.Attributes.Add("address1_line2", request.Address_Line2);
            ...
            if (!string.IsNullOrEmpty(request.Address_Country))
                contactEntity.Attributes.Add("address1_country", request.Address_Country);
        ...
        private void UpdateContactFieldsIfOriginalFieldsAreNull(AutoRgCaseRequest request, Account customer)
        {
            ...
            else
            {
                ...
                if (string.IsNullOrEmpty(customer?.FirstName) && !string.IsNullOrEmpty(request.FirstName))
                    origContact.Attributes.Add("firstname", request.FirstName);

                if (string.IsNullOrEmpty(customer?.LastName) && !string.IsNullOrEmpty(request.LastName))
                    origContact.Attributes.Add("lastname", request.LastName);
            }
            ...
            if (string.IsNullOrEmpty(customer?.Telephone3) && !string.IsNullOrEmpty(request.MobileNo))
                origContact.Attributes.Add("telephone3", request.MobileNo);

            if (string.IsNullOrEmpty(customer?.SocialSecurityNumber) && !string.IsNullOrEmpty(request.SocialSecurityNumber))
                origContact.Attributes.Add("cgi_socialsecuritynumber", request.SocialSecurityNumber);

            if (string.IsNullOrEmpty(customer?.Address1_line1) && !string.IsNullOrEmpty(request.Address_Line1))
                origContact.Attributes.Add("address1_line1", request.Address_Line1);

            if (string.IsNullOrEmpty(customer?.Address1_line2) && !string.IsNullOrEmpty(request.Address_Line2))
                origContact.Attributes.Add("address1_line2", request.Address_Line2);

            if (string.IsNullOrEmpty(customer?.Address1_city) && !string.IsNullOrEmpty(request.Address_City))
                origContact.Attributes.Add("address1_city", request.Address_City);

            if (string.IsNullOrEmpty(customer?.Address1_postalcode) && !string.IsNullOrEmpty(request.Address_PostalCode))
                origContact.Attributes.Add("address1_postalcode", request.Address_PostalCode);

            if (string.IsNullOrEmpty(customer?.Address1_country) && !string.IsNullOrEmpty(request.Address_Country))
        ...
        private Guid CreateCustomer(string firstName, string lastName, string emailAddress, string mobilePhoneNumber)
        {
            ...
            if (!string.IsNullOrEmpty(mobilePhoneNumber))
                customerEntity.Attributes.Add("telephone3", mobilePhoneNumber);
        ...
        internal UpdateAutoRgCaseResponse RequestCreateAutoRgRefundDecision(UpdateAutoRgCaseRequest request)
        {
            ...
            try
            {
                ...
                var setting = GetRgolSettingFromRefundType(request.RefundType);
