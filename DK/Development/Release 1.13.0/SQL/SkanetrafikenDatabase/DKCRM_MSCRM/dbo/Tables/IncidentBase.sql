CREATE TABLE [dbo].[IncidentBase] (
    ...
    [cgi_bic]                               NVARCHAR (50)    NULL,
    [cgi_description2]                      NVARCHAR (MAX)   NULL,
    [cgi_rgol_socialsecuritynumber]         NVARCHAR (100)   NULL,
    [cgi_rgol_telephonenumber]              NVARCHAR (100)   NULL,
    [cgi_rgol_fullname]                     NVARCHAR (100)   NULL,
    [cgi_rgol_address1_line1]               NVARCHAR (100)   NULL,
    [cgi_rgol_address1_line2]               NVARCHAR (100)   NULL,
    [cgi_rgol_address1_postalcode]          NVARCHAR (100)   NULL,
    [cgi_rgol_address1_city]                NVARCHAR (100)   NULL,
    [cgi_rgol_address1_country]             NVARCHAR (100)   NULL,
    [cgi_rgol_delivery_email]               NVARCHAR (100)   NULL,
