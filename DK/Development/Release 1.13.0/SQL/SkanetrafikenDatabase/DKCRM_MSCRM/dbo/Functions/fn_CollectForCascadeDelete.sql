...
if(@y in(1,2,3,4,112,123,127,1010,1011,1024,1084,1088,1090,4000,4001,4003,4006,4201,4202,4204,4206,4207,4208,4209,4210,4211,4212,4214,4215,4216,4251,4300,4400,4401,4402,4414,4703,8181,8199,9300,9507,9600,9605,9606,9700,9701,9702,9750,10000,10008,10009,10019,10025,10027,10064))
...
if(@y in(1,2,3,4,112,1010,1084,1088,1090,4400,4402,4406,10000,10014,10025,10027,10064))begin
...
if(@y in(1,2,3,4,112,1010,1084,1088,1090,4400,4402,4406,9700,9702,10000,10014,10025,10027,10064))begin
...
if(@y in(1,2,3,4,112,1010,1084,1088,1090,4400,4402,4406,4700,9700,9702,10000,10014,10025,10027,10064))
...
if(@y in(1,2,3,4,9,99,112,123,1010,1084,1088,1090,4000,4005,4007,4200,4201,4202,4204,4207,4210,4212,4214,4216,4251,4300,4400,4402,4710,9600,9700,10000,10008,10009,10064))begin
...
if(@y in(1,2,3,4,112,1010,1084,1088,1090,4400,4402,9700,9702,10000,10014,10025,10027,10064))
...
if(@y in(1,2,3,4,112,1010,1084,1088,1090,4406,4700,9700,9702,10000,10014,10025,10027,10064)and @f=0)
...
if(@y in(9702,10000,10014,10025,10027,10064))
