...
namespace CRM2013.SkanetrafikenPlugins
{
    public class contact_Post : IPlugin
    {
        ...
        //            || data.Target.Contains("firstname")
        //            || data.Target.Contains("lastname")
        ...
        //            || data.Target.Contains("cgi_socialsecuritynumber"))
        //    {
        //        // Sync with e-handel. 
        ...
        public static void UpdateQueueItems(string contactId, string fullName, IOrganizationService service)
        {
            // Query gets:
