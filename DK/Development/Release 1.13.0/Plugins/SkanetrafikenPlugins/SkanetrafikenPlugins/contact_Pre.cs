...
namespace CRM2013.SkanetrafikenPlugins
{
    ...
    {
        private Object autonumberLock = new Object();
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            */
            ...
            if (data.Context.InputParameters.Contains("Target") && data.Context.InputParameters["Target"] is Entity)
            {
                ...
                data.Target.Attributes["cgi_contactnumber"] = Common.CustomerHandler.getNextCustomerNumber("CustomerNumberContact", data).ToString();
