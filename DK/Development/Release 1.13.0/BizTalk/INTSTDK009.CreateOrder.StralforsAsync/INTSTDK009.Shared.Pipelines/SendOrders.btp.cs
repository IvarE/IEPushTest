namespace INTSTDK009.Shared.Pipelines
{
    ...
    public sealed class SendOrders : Microsoft.BizTalk.PipelineOM.SendPipeline
    {
...
"     <Component>          <Name>INTSTDK009.Shared.PipelineComponents.Archiver.ArchiverComponent,INTS"+
"TDK009.Shared.PipelineComponents.Archiver, Version=1.0.0.0, Culture=neutral, PublicKeyToken=3696f8b0"+
"d65bcb41</Name>          <ComponentName>Archiver</ComponentName>          <Description>This componen"+
"t saves the file in an archive.</Description>          <Version>1.1</Version>          <Properties> "+
"           <Property Name=\"ArchivePath\" />            <Property Name=\"ArchiveFileName\" />           "+
" <Property Name=\"Enabled\">              <Value xsi:type=\"xsd:boolean\">false</Value>            </Pro"+
"perty>            <Property Name=\"Promote_ARCHIVED_AS_Prop\">              <Value xsi:type=\"xsd:boole"+
"an\">false</Value>            </Property>          </Properties>          <CachedDisplayName>Archiver"+
"</CachedDisplayName>          <CachedIsManaged>true</CachedIsManaged>        </Component>      </Com"+
"ponents>    </Stage>  </Stages></Document>";
        
        private const string _versionDependentGuid = "ac24ea36-df42-4036-a38d-e17c104cc2c7";
...
"     <Value xsi:type=\"xsd:boolean\">false</Value>    </Property>  </Properties></PropertyBag>";
            ...
            IBaseComponent comp2 = Microsoft.BizTalk.PipelineOM.PipelineManager.CreateComponent("INTSTDK009.Shared.PipelineComponents.Archiver.ArchiverComponent,INTSTDK009.Shared.PipelineComponents.Archiver, Version=1.0.0.0, Culture=neutral, PublicKeyToken=3696f8b0d65bcb41");;
