...
namespace CRM2013.SkanetrafikenPlugins
{
    ...
    public static class CustomerHandler
    {
        ...
        public static void ExecuteCustomerSyncronization(IOrganizationService service, string customerId)
        {
            ...
            {
                throw new InvalidPluginExecutionException(string.Format("Ett oväntat fel uppstod i ExecuteTravelCardSyncronization, customerId = {0}. Detaljerat felmeddelande: {1}", customerId, ex.ToString()));
            }
