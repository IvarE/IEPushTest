...
Const baseURL = "http://V-DKCRM-TST:4004/CallGuide/DoAction.aspx" ' base addres for CRM posting '
Const guidURL = "http://V-DKCRM-TST:4004/CallGuide/GetUserGuid.aspx" ' base address to retrieve Agent GUID '
