...
rem 2.0     CGI         2015-11-20 Förändrat ScreenPop funktion, tar bort popup som hanterar okänt val
rem ************************************************************************
rem 'UTV miljön
...
function ScreenPop()
    ...
    if ContactSourceType = "chat" or ContactSourceType = "emailserver" then
     ...
     ' else
        ' errorMsg = "Systemet kan inte hantera ditt val. Kontakta en administratör. Felinformation: ContactSourceType är [" & ContactSourceType & "] och OrigContactSourceType är [" & OrigContactSourceType & "]"
	    ' ErrorMessage errorMsg, 0, "Felmeddelande"
     end if
End function
