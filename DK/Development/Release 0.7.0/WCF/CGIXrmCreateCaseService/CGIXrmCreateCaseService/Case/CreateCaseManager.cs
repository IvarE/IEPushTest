        ...
        internal UpdateAutoRGCaseResponse RequestCreateTravelInformationLinkedToCase(UpdateAutoRGCaseRequest request)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(request.TravelInformationDisplayText))
                {
                    ...
                    string plannedStartTime = request.TravelInformationStartPlanned.Value.ToString("H:mm:ss");
                    string actualStartTime = Convert.ToDateTime(request.TravelInformationStartActual).ToString("H:mm:ss");
                    TimeSpan diffStartTimeSpan = Convert.ToDateTime(request.TravelInformationStartActual) - request.TravelInformationStartPlanned.Value;
                    ...
                    //Arrive time
                    string plannedEndTime = request.TravelInformationArrivalPlanned.Value.ToString("H:mm:ss");
                    string actualEndTime = Convert.ToDateTime(request.TravelInformationArrivalActual).ToString("H:mm:ss");
                    TimeSpan diffEndTimeSpan = Convert.ToDateTime(request.TravelInformationArrivalActual) - request.TravelInformationArrivalPlanned.Value;
                    string diffEndTime = "";
