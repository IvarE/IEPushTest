...
namespace CGICRMPortalService
{
    public class CustomerManager
    {
        ...
        /// <summary>
        /// Enumerator for Account/Contact in customer entity record state.
        /// </summary>
        ...
        private int ConvertCustomerStateToCrm(bool statecode)
        {
            ...
            {
                case false:
                    return (int)StateCode.Active;
                    break;
                case true:
                    return (int)StateCode.Inactive;
                    break;
                default:
                    return (int)StateCode.Inactive;
                    break;
        ...
        private Entity GetAccountEntityFromCustomer(Customer customer, bool bUpdate)
        {
            ...
            try
            {
                ...
                account.Attributes.Add("cgi_activated", customer.InActive);
                account.Attributes.Add("statuscode", ConvertCustomerStateToCrm(customer.Deleted));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        private Entity GetContactEntityFromCustomer(Customer customer, bool bUpdate)
        {
            ...
            contact.Attributes.Add("cgi_debtcollection", customer.InActive);
            contact.Attributes.Add("statecode", customer.Deleted);
