    ...
    public class RunBatch
    {
        ...
        public bool Run()
        {
            ...
            try
            {
                ...
                _fileName = string.Format("{0}\\DK_utbet_inland_{1}", _exportdir, _now + ".txt");
        ...
        {
            string _line1 = "02";
            string _line2 = _formatSocNumber(_formatString(refund.Soc_sec_number), _formatString(refund.Foreign_payment)).PadRight(15);
            string _line3 = string.Format("{0} {1}", _formatString(contact.Lastname), _formatString(contact.Firstname)).PadRight(30);
            string _line4 = contact.Address1_line1.SetToFixedLength(30);
            string _line5 = string.Format("{0}  {1}", _formatString(contact.Address1_postalcode), _formatString(contact.Address1_city)).PadRight(30);
            string _line6 = "1500".PadRight(12);
        ...
        private string _createInvoiceRecord(refund refund, contact contact)
        {
            string _line1 = "03";
            string _line2 = _formatSocNumber(_formatString(refund.Soc_sec_number), _formatString(refund.Foreign_payment)).PadRight(15);
            string _line3 = _formatCreateDate(refund.CreatedOn).PadRight(8);
            string _line4 = _formatCreateDate(refund.CreatedOn).PadRight(8);
            string _line5 = _formatCreateDate(refund.CreatedOn).PadRight(8);
            string _line6 = "".PadRight(8);
            string _line7 = _calculatenetamount(refund.Amount, refund.Vat_code_name).PadRight(16); //ex moms

            //Calculate totalsum of all invoivcerows..
            _totalsum = _totalsum + refund.Amount.Value;

            string _line8 = _calculateVatAmount(refund.Amount, refund.Vat_code_name).PadRight(16);
            string _line9 = _formatVatCode(refund.Vat_code_name).PadRight(2);
        ...
        {
            string _line1 = "04";
            string _line2 = _formatString(incident.Ticketnumber).PadRight(50);
            string _line3 = _calculatenetamount(refund.Amount, refund.Vat_code_name).PadRight(16); //ex moms
            string _line4 = _formatVatCode(refund.Vat_code_name).PadRight(2);
        ...
        private string _createAcountingRecord(refund refund, contact contact, incident incident, responsible responsible, refundproduct refundproduct, user user, refundaccount refundaccount)
        {
            ...
            string _line2 = _formatString(_account).PadRight(10);

            string _line3 = "";
            if (responsible != null)
                _line3 = _formatString(responsible.Responsible).PadRight(10);
            else
                _line3 = _formatString("").PadRight(10);
            
            string _line4 = "1500".PadRight(10);
            string _line5 = "".PadRight(10);

            string _line6 = "";
            if (refundproduct != null)
                _line6 = _formatString(refundproduct.Account).PadRight(10);
            else
                _line6 = _formatString("").PadRight(10);
            

            string _line7 = "".PadRight(10);
            string _line8 = _formatVatCode(refund.Vat_code_name).PadRight(10);
            string _line9 = _checkLenght(string.Format("{0} {1} {2}", _formatString(incident.Ticketnumber), _formatString(contact.Lastname), _formatString(contact.Firstname)).PadRight(30));
            string _line10 = _calculatenetamount(refund.Amount, refund.Vat_code_name).PadRight(16); //ex moms
            string _line11 = (!string.IsNullOrEmpty(user.RsId)) ? user.RsId.PadRight(10) : "".PadRight(10);   // "".PadRight(10); //RSID
            string _line12 = "".PadRight(10);
        ...
        private string _getxmlPendingRefunds()
        {
            ...
            _xml += "               <condition attribute='cgi_payment' operator='eq' value='1' />";
            _xml += "           </filter>";
            _xml += "       </link-entity>";
            _xml += "   </entity>";
            _xml += "</fetch>";
