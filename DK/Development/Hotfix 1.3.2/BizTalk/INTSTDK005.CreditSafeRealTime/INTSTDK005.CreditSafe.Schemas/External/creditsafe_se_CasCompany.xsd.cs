namespace INTSTDK005.CreditSafe.Schemas {
    ...
    public sealed class Cas_Service_webservice_creditsafe_se_CAS : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:complexType name=""CAS_COMPANY_RESPONSE"">
    <xs:sequence>
      ...
      <xs:element minOccurs=""0"" maxOccurs=""1"" name=""Town"" type=""xs:string"" />
        ...
        public Cas_Service_webservice_creditsafe_se_CAS() {
        }
        ...
        [Schema(@"https://webservice.creditsafe.se/CAS/",@"CasCompanyService")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"https://webservice.creditsafe.se/CAS/",@"CasCompanyServiceResponse")]
        [System.SerializableAttribute()]
