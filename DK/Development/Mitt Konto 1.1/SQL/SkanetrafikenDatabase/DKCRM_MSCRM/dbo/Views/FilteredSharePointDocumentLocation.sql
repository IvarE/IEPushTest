...
select
    ...
    dbo.fn_UTCToTzSpecificLocalTime([SharePointDocumentLocation].[CreatedOn], 
			us.TimeZoneBias,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([SharePointDocumentLocation].[ModifiedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([SharePointDocumentLocation].[OverriddenCreatedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
