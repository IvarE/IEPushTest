...
namespace INTSTDK010.Shared.PipelineComponents.Archiver
{
    /// <summary>
    ...
    [System.Runtime.InteropServices.Guid("a4ca40ea-f09b-43b7-b815-669394dbfb60")]
        ...
        IComponentUI, IPersistPropertyBag
    {
        ...
        {
            get { System.Diagnostics.Trace.WriteLine("INTSTDK0010.Shared.PipelineComponents.Archiver:ArchivePath"); return archivePath; }
        ...
        /// </summary>
        [DescriptionAttribute("The filename to use when archiving. Supports the macros %date%, %MessageID%, %SourceFileName%")]
        public string ArchiveFileName
        {
            get { System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:ArchiveFileName"); return archiveFileName; }
        ...
        public bool Enabled
        {
            get { System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Enabled"); return enabled; }
            set { enabled = value; }
        }
        ...
        {
            get { System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Promote_ARCHIVED_AS"); return promote_ARCHIVED_AS_Prop; }
        ...
        {
            get { System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Description"); return "This component saves the file in an archive."; }
        }
        ...
        public string Name
        {
            get { System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Name"); return "Archiver"; }
        }
        ...
        {
            get { System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Version"); return "1.1"; }
        }
        ...
        {
            System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Execute");
        ...
        {
            System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:GetArchivePathAndFileName");
            ...
            if (!string.IsNullOrEmpty(newFileName))
            {
                ...
                newFileName = newFileName.Replace("%SourceFileName%", fileName);
                fileName = newFileName;
                System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Execute. FileName = " + fileName);
            }
        ...
        {
            System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:HandleDuplicateNames");
        ...
        public IntPtr Icon
        {
            get { System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Icon "); return IntPtr.Zero; }
        }
        ...
        {
            System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Validate");
        ...
        {
            classID = new Guid("a4ca40ea-f09b-43b7-b815-669394dbfb60");
            System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:ClassID: " + classID);
        }
        ...
        public void InitNew()
        {
            System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:InitNew");
        }
        ...
        {
            System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Load");
            object val = null;
        ...
        {
            System.Diagnostics.Trace.WriteLine("INTSTDK010.Shared.PipelineComponents.Archiver:Save");
