...
select
    ...
    [Goal].[CreatedBy],
    [Goal].[CreatedByName],
    dbo.fn_UTCToTzSpecificLocalTime([Goal].[CreatedOn], 
			us.TimeZoneBias,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([Goal].[GoalEndDate], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([Goal].[GoalStartDate], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([Goal].[LastRolledupDate], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    [Goal].[ModifiedBy],
    [Goal].[ModifiedByName],
    dbo.fn_UTCToTzSpecificLocalTime([Goal].[ModifiedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([Goal].[OverriddenCreatedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
