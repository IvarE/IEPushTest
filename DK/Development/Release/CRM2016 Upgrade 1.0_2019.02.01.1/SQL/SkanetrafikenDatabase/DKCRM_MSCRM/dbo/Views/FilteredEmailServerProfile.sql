...
select
    ...
    dbo.fn_UTCToTzSpecificLocalTime([EmailServerProfile].[CreatedOn], 
			us.TimeZoneBias,
    ...
    --[EmailServerProfile].[EntityImage]
    ...
    dbo.fn_UTCToTzSpecificLocalTime([EmailServerProfile].[ModifiedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([EmailServerProfile].[ProcessEmailsReceivedAfter], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
