CREATE TABLE [dbo].[AccountBase] (
    ...
    [cgi_organizational_number]    NVARCHAR (100)   NULL,
    [cgi_organization_sub_number]  NVARCHAR (100)   NULL,
...
GO
CREATE NONCLUSTERED INDEX [ndx_QF_cgi_organizational_number]
    ON [dbo].[AccountBase]([cgi_organizational_number] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [ndx_QF_cgi_FirstName]
    ON [dbo].[AccountBase]([cgi_FirstName] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [ndx_QF_cgi_LastName]
    ON [dbo].[AccountBase]([cgi_LastName] ASC) WITH (FILLFACTOR = 80);
