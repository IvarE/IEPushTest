...
namespace CGIXrmHandler.CrmClasses
{
    ...
    public class Incident : XrmBaseEntity
    {
        ...
        // address1_postalcode & address1_city! Use splitter function.
        [Xrm("cgi_spa")]
        public string sPA { get; set; }

        // telephone2 in CGI-solution
        [Xrm("cgi_sph")]
        public string sPH { get; set; }

        // telephone1 in CGI-solution
        [Xrm("cgi_spw")]
        public string sPW { get; set; }

        // telephone3 in CGI-solution
        [Xrm("cgi_spm")]
        ...
        // cgi_socialsecuritynumber, use formatter function
