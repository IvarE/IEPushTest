    ...
    */
    ...
    public class MainPageViewModel
    {
        ...
        public void GetSavedLines(string id)
        {
            ...
            {
                _mainpage.ShowError(e, "Error test");
            }
            try
            {
        ...
        public MainPageViewModel(MainPage mainpage, Dispatcher theDispatcher, string clientUrl, string querystring, string initparams)
        {
            try
            {
            ...
            try
            {
                ...
                if (e.Result.DirectJourneysBetweenStops != null)
                {
                    ...
                    for (int i = 0; i < journeyCount; i++)
                    {
                        ...
                        {
                            int result;
                            string trainType = string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].LineDesignation) ? "" : e.Result.DirectJourneysBetweenStops[i].LineDesignation;
                            if (int.TryParse(trainType, out result))
                            {
                                //Öresundståg
                                _t.Line = string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].LineDesignation) ? "" : e.Result.DirectJourneysBetweenStops[i].LineDesignation;
                                ...
                                _t.Transport = "Öresundståg";
                            }
                            else
                            {
                                //DatedVehicleJourneyId position 8-11 innehåller Linje ID (cgi_line)..
                                //string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].DatedVehicleJourneyId) ? "" : e.Result.DirectJourneysBetweenStops[i].DatedVehicleJourneyId;
                                if (!string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].ServiceJourneyGid) && int.TryParse(e.Result.DirectJourneysBetweenStops[i].ServiceJourneyGid.Substring(7,4), out result))
                                {     
                                    //                               
                                    string t1 = e.Result.DirectJourneysBetweenStops[i].ServiceJourneyGid.Substring(7,4);
                                    string t2 = Convert.ToInt32(t1).ToString(); //Removes first zero if there is one.

                                    _t.Line = t2;
                                    _t.LineDesignation = t2;
                                }
                                
                                //_t.Line = string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].LineDesignation) ? "" : e.Result.DirectJourneysBetweenStops[i].LineDesignation;
                                //_t.LineDesignation = string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].LineDesignation) ? "" : e.Result.DirectJourneysBetweenStops[i].LineDesignation;
                                _t.Transport = string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].LineDesignation) ? "" : e.Result.DirectJourneysBetweenStops[i].LineDesignation;
                            }
                            _t.Tour = string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].JourneyNumber) ? "" : e.Result.DirectJourneysBetweenStops[i].JourneyNumber; //_header.SelectedTransport == null ? "" : _header.SelectedTransport.Caption;
                            _t.TrainNumber = string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].JourneyNumber) ? "" : e.Result.DirectJourneysBetweenStops[i].JourneyNumber;
                            ...
                            if (_header.SelectedTransport.Id == 2) //City Bus
                            {
                                _t.City = _header.SelectedCity == null ? "" : _header.SelectedCity.ZoneShortName;
                            }
                            else if (_header.SelectedTransport.Id == 3) //Region Bus
                            {
                                _t.City = "";
                            }

                            _t.Transport = _header.SelectedTransport == null ? "" : _header.SelectedTransport.Caption;
                            _t.Line = _header.SelectedTour == null ? "" : _header.SelectedTour.LineNumber;
                            _t.LineDesignation = string.IsNullOrEmpty(e.Result.DirectJourneysBetweenStops[i].LineDesignation) ? "" : e.Result.DirectJourneysBetweenStops[i].LineDesignation;
                        ...
                        //Always the same dosn't matter if its a bus or a train..
                        ...
                        _t.Start = _header.SelectedStopAreaFrom.StopAreaName;
                        _t.Stop = _header.SelectedStopAreaTo.StopAreaName;
                        ...
                        if (e.Result.DirectJourneysBetweenStops[i].ObservedArrivalDateTime != DateTime.MinValue)
                        {
                            ...
                            //_ArivalActual = e.Result.DirectJourneysBetweenStops[i].ObservedArrivalDateTime;
                            //_ArivalPlanned = e.Result.DirectJourneysBetweenStops[i].PlannedArrivalDateTime;
                            ...
                            _t.ArivalActual = _actual + " (" + _minutes + ")";
                            _t.ArrivalDifference = _minutes;
                            _t.PlannedArivalTimeDisplay = string.Format("{0}", _planned);
                            _t.ArrivalActualDateTime = e.Result.DirectJourneysBetweenStops[i].ObservedArrivalDateTime.ToString("yyyy-MM-dd HH:mm");
                        }
                        else
                        {
                            _t.ArivalActual = "X";
                            _t.PlannedArivalTimeDisplay = "";
                            _t.ArrivalActualDateTime = "";
                        }
                        ...
                        if (e.Result.DirectJourneysBetweenStops[i].ObservedDepartureDateTime != DateTime.MinValue)
                        {
                            ...
                            _t.StartActual = _actual + " (" + _minutes + ")";
                            _t.StartDifference = _minutes;
                            _t.PlannedStartTimeDisplay = string.Format("{0}", _planned);
                            _t.StartActualDateTime = e.Result.DirectJourneysBetweenStops[i].ObservedDepartureDateTime.ToString("yyyy-MM-dd HH:mm");
                        }
                        else
                        {
                            _t.StartActual = "X";
                            _t.PlannedStartTimeDisplay = "";
                            _t.StartActualDateTime = "";
                        }
                        _t.StartPlanned = e.Result.DirectJourneysBetweenStops[i].PlannedDepartureDateTime.ToString("yyyy-MM-dd HH:mm");

                        if (e.Result.DirectJourneysBetweenStops[i].ObservedDepartureDateTime != DateTime.MinValue)
                        {
                            _t.FailedToDepart = false;
                        }
                        else
                        {
                            _t.FailedToDepart = true;
                        }
                        if (e.Result.DirectJourneysBetweenStops[i].ObservedArrivalDateTime != DateTime.MinValue)
                        {
                            _t.FailedToArrive = false;
                            _t.FailedToDepart = false;
                        }
                        else
                        {
                            _t.FailedToArrive = true;
                        }
                        #endregion startTider
        ...
        private void _pubtransClient_GetCallsForServiceJourneyCompleted(object sender, GetCallsForServiceJourneyCompletedEventArgs e)
        {
            try
            {
                ...
                */
                ...
                //throw new InvalidProgramException("Hello World!");
        ...
        private string _setSaveMessage(TravelInformation travelinfo)
        {
            ...
            {
                int result;
                string trainType = string.IsNullOrEmpty(travelinfo.LineDesignation) ? "" : travelinfo.LineDesignation;
                if (int.TryParse(trainType, out result))
                {
                    //Öresundståg
                    //_city = "";
                    _tour = string.Format("Linje: {0} [{1}]", travelinfo.LineDesignation, travelinfo.JourneyNumber);
                }
                else
                {
                    //_city = "";
                    //_tour = "";//string.Format("Linje: [{0}]", travelinfo.LineDesignation);
                }
            }
            else
            {
                ...
                //    //_city = "";
                //}
                _tour = string.Format("Linje: {0} [{1}] ({2})", travelinfo.LineDesignation, travelinfo.JourneyNumber, travelinfo.DirectionTextOrg);
            }

            //_trafik = string.Format("Trafikslag: {0}", _header.SelectedTour.LineName);
            _trafik = string.Format("Trafikslag: {0}", _header.SelectedTransport.Caption);
            _line = string.Format("Resa: {0} [{1}] {2} - {3} [{4}] {5}",
        ...
        private void _saveSelectionToCRM(TravelInformation travelinformation)
        {
            try
            {
                ...
                if (travelinformation.StartActualDateTime != null && !string.IsNullOrEmpty(travelinformation.StartActualDateTime))
                    entity["cgi_startactualdatetime"] = SplitDateTime(travelinformation.StartActualDateTime);
                ...
                if (travelinformation.ArrivalActualDateTime != null && !string.IsNullOrEmpty(travelinformation.ArrivalActualDateTime))
                    entity["cgi_arrivalactualdatetime"] = SplitDateTime(travelinformation.ArrivalActualDateTime);
                ...
                if (travelinformation.Line != null && !string.IsNullOrEmpty(travelinformation.Line))
                    entity["cgi_line"] = travelinformation.Line;

                //if (travelinformation.StartDifference != null && !string.IsNullOrEmpty(travelinformation.StartDifference))
                //    entity["cgi_startdifference"] = travelinformation.StartDifference;

                //if (travelinformation.ArrivalDifference != null && !string.IsNullOrEmpty(travelinformation.ArrivalDifference))
                //    entity["cgi_arrivaldifference"] = travelinformation.ArrivalDifference;

                //entity["cgi_failedtodepart"] = travelinformation.FailedToDepart;
                //entity["cgi_failedtoarrive"] = travelinformation.FailedToArrive;

                if (travelinformation.LineType != null && !string.IsNullOrEmpty(travelinformation.LineType))
                    entity["cgi_linetype"] = travelinformation.LineType;

                if (travelinformation.TrainNumber != null && !string.IsNullOrEmpty(travelinformation.TrainNumber))
                    entity["cgi_trainnumber"] = travelinformation.TrainNumber;

                if (travelinformation.LineDesignation != null && !string.IsNullOrEmpty(travelinformation.LineDesignation))
                    entity["cgi_linedesignation"] = travelinformation.LineDesignation;
