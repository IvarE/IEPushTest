...
public partial class doaction : System.Web.UI.Page
{
    ...
    private void DoAction(CallGuideRequest callguideRequest,Guid callerId)
    {
        try
        {
            ...
            _log.Debug("Entering Do Action Method. CGIXrmPortal");
            ...
            if (callerId == Guid.Empty)
            {
                ...
                _log.Debug("Processed callerid since callerid supplied was empty" + "DoAction" + "CGIXrmPortal");
            }
                ...
                if (callerId != Guid.Empty)
                {
                    switch (callguideRequest.ContactSourceType.ToLowerInvariant())
                    {
                        case "ivr":
                            ...
                            _log.Debug("IVR Request" + "DoAction" + "CGIXrmPortal");
                        ...
                        case "chat":
                            ...
                            _log.Debug("Chart Request" + "DoAction" + "CGIXrmPortal");
                            if (callguideRequest.ScreenPopChoice.ToLowerInvariant() == "manual")
                            {
                                callguideRequest.CallDirection = CallDirection.Incoming;
                        ...
                        case "emailserver":
                            ...
                            _log.Debug("Email Request" + "DoAction" + "CGIXrmPortal");
                            if (callguideRequest.ScreenPopChoice.ToLowerInvariant() == "manual")
                            {
                                callguideRequest.CallDirection = CallDirection.Incoming;
        ...
        {
            _log.Error("Error Processing Request with Error Message :" + ex.Message + ". DoAction. Ex: " + ex + ". CGIXrmPortal");
