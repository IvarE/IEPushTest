    ...
    public class AllBinaryManager
    {
        ...
        public GetCustomerDetailsResponse GetCustomerDetails(Guid customerId, AccountCategoryCode customerType)
        {
            ...
            catch (FaultException<OrganizationServiceFault> ex)
            {
                ...
                _log.Error($"Exception: {exceptionMsg}. UpdateCustomer. FaultException: {ex}. In Portal Web Service");
            ...
            catch (TimeoutException ex)
            {
                ...
                //_log2Crm.Exception(exceptionMsg, "UpdateCustomer", ex, "Portal Web Service");
                _log.Error($"Exception: {exceptionMsg}. UpdateCustomer. TimeoutException: {ex}. In Portal Web Service");
                response.Status = ProcessingStatus.FAILED;
                response.Message = exceptionMsg;
            }
            catch (Exception ex)
            {
                ...
                if (ex.InnerException != null)
                {
                    ...
                    if (fe != null)
                    {
                        ...
                        //_log2Crm.Exception(exceptionMsg, "UpdateCustomer", ex, "Portal Web Service");
                        _log.Error($"Exception: {exceptionMsg}. UpdateCustomer. Exception: {ex}. In Portal Web Service");
