    ...
    public class CreateCaseManager
    {
        ...
        */
            ...
            string customerMessage)
        {
            ...
            var valueCodeValidForMonths = GetSetting<int>(_xrmManager.Service, "cgi_valuecodevalidformonths");
            var valueCodeValidDate = GetSetting<DateTime>(_xrmManager.Service, "ed_valuecodevaliddate");

            if (valueCodeValidForMonths >= 1)
                refundEntity.Attributes.Add("cgi_last_valid", DateTime.Now.AddMonths(valueCodeValidForMonths));
            else if (valueCodeValidDate >= DateTime.Now)
                refundEntity.Attributes.Add("cgi_last_valid", valueCodeValidDate);
        ...
        internal UpdateAutoRgCaseResponse RequestCreateAutoRgRefundDecision(UpdateAutoRgCaseRequest request)
        {
            ...
            try
            {
                ...
                // Do debug-tracing. Johan Endeavor
                if (DateTime.Now < new DateTime(2017, 11, 15))
                {
                    _log.Debug(string.Format("============================================"));
                    _log.Debug(string.Format("Start RequestCreateAutoRgRefundDecision"));
                    //LogMessage(_logLocation, string.Format("============================================"));
                    //LogMessage(_logLocation, string.Format("Start RequestCreateAutoRgRefundDecision"));
                }
                ...
                if (request.IsCompleted == false && request.ReqReceipt)
                {
                    if (DateTime.Now < new DateTime(2017, 11, 15))
                    {
                        ...
                        //LogMessage(_logLocation, string.Format("1. RequestCreateAutoRgRefundDecision"));
                    }
                ...
                else if (request.IsCompleted == false && request.ReqReceipt == false)
                {
                    if (DateTime.Now < new DateTime(2017, 11, 15))
                    {
                        ...
                        //LogMessage(_logLocation, string.Format("2. RequestCreateAutoRgRefundDecision"));
                    }
                ...
                else if (request.IsCompleted && request.Approved)
                {
                    if (DateTime.Now < new DateTime(2017, 11, 15))
                    {
                        ...
                        //LogMessage(_logLocation, string.Format("3. RequestCreateAutoRgRefundDecision"));
                    }
                ...
                else if (request.IsCompleted && request.Approved == false)
                {
                    if (DateTime.Now < new DateTime(2017, 11, 15))
                    {
                        ...
                        //LogMessage(_logLocation, string.Format("4. RequestCreateAutoRgRefundDecision"));
                    }
        ...
        internal UpdateAutoRgResponse RequestCreateTravelInformationLinkedToCase(UpdateAutoRgCaseTravelInformationsRequest request)
        {
            ...
            try
            {
                        ...
                        Attributes = new AttributeCollection
                {
                    ...
                    //travelInformation.Attributes.Add("cgi_failedtoarrive", failedToArrive);
                    //travelInformation.Attributes.Add("cgi_failedtodepart", failedToStart);
