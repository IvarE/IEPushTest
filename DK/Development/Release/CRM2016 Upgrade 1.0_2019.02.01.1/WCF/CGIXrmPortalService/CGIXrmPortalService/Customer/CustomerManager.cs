...
namespace CGICRMPortalService.Customer
{
    public class CustomerManager
    {
        ...
        private void HandleFaultException(UpdateCustomerResponse response, FaultException<OrganizationServiceFault> ex, string methodName)
        {
            ...
            _log.Error($"UpdateCustomerResponse FaultException: {exceptionMsg}");
        }
        ...
        private void HandleTimeOutExceptionn(UpdateCustomerResponse response, TimeoutException ex, string methodName)
        {
            ...
            _log.Error($"UpdateCustomerResponse TimeoutException: {exceptionMsg}");
        }
        ...
        private void HandleException(UpdateCustomerResponse response, Exception ex, string methodName)
        {
            ...
            else
            {
                ...
                _log.Error($"UpdateCustomerResponse FaultException InnerExceptionNull: {exceptionMsg}");
            }
        }
        ...
        public string GetAccountNumber(Guid customerId, AccountCategoryCode customerType)
        {
            ...
            if (customerId == Guid.Empty)
            {
                ...
                _log.Error($"GetAccountNumber. ErrorMsg: {errorMsg}. ExceptionMsg: {exceptionMsg}");
        ...
        public CheckCustomerExistResponse CheckCustomerExist(string customerEmail)
        {
            ...
            try
            {
                if (customerEmail == null)
                {
                    ...
                    _log.Error($"CheckCustomerExist. ErrorMsg: {errorMsg}. ExceptionMsg: {exceptionMsg}");
                    throw nullReferenceException;
                }
            ...
            catch (FaultException<OrganizationServiceFault> ex)
            {
                ...
                _log.Error($"FaultException: {exceptionMsg}");
            }
            catch (TimeoutException ex)
            {
                ...
                _log.Error($"TimeoutException: {exceptionMsg}");
            }
            catch (Exception ex)
            {
                // Display the details of the inner exception.
                if (ex.InnerException != null)
                {
                    ...
                    _log.Error($"FaultException InnerException: {exceptionMsg}");
                }
                else
                {
                    string exceptionMsg = "The application terminated with an error." + ex.Message;
                    ...
                    _log.Error($"FaultException InnerExceptionNull: {exceptionMsg}");
                }
            }
        ...
        public CreateCustomerResponse CreateCustomer(Models.Customer customer)
        {
            ...
            try
            {
                ...
                switch (customer.CustomerType)
                {
                    case AccountCategoryCode.Private:
                        ...
                        _log.Debug($"Obsolete kod hittad (Create contact). Denna metod skall inte anropas!");
            ...
            catch (Exception ex)
            {
                ...
                if (ex.InnerException != null)
                {
                    ...
                    _log.Error($"Exception InnerException: {exceptionMsg}");
                }
                else
                {
                    string exceptionMsg = "The application terminated with an error." + ex.Message;
                    ...
                    _log.Error($"Exception InnerExceptionNull: {exceptionMsg}");
                }
            }
            return response;
        }
        ...
        public GetCustomerResponse GetCustomer(Guid customerId, AccountCategoryCode customerType)
        {
            ...
            if (customerId == Guid.Empty)
            {
                ...
                _log.Error($"NullReferenceException: {exceptionMsg}");
