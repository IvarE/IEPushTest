    ...
    public class TravelCardManager : Response
    {
        ...
        private void _createLogfile(string input)
        {
            try
            {
                ...
                StreamWriter sw = new StreamWriter(path + "travelcard.log", true);
        ...
        public RegisterTravelCardResponse RegisterTravelCard_CreateOrUpdate(Models.TravelCard travelCard)
        {
            ...
            try
            {
                ...
                if (IsCardExisting(travelCard.CardNumber) == false)
                {
                    ...
                    regTravelCardResponse.TravelCardId = crmTravelCardId;
                ...
                else if (IsCardExistingAndNotRegistered(travelCard.CardNumber))
                {
                    ...
                    regTravelCardResponse.Status = ProcessingStatus.SUCCESS;
                    regTravelCardResponse.TravelCardId = crmTravelCard.Id;
        ...
        public UpdateTravelCardResponse UpdateTravelCard(Models.TravelCard travelCard)
        {
            ...
            try
            {
                if (IsCardExisting(travelCard.CardNumber))
                {
                    ...
                    _xrmMgr.Service.Update(crmTravelCard);
                    updateTravelCardResponse.AccountId = travelCard.AccountId;
                    updateTravelCardResponse.TravelCardId = crmTravelCard.Id;
        ...
        public GetCardsForCustomerResponse GetCardsForCustomer(Guid customerId, AccountCategoryCode customerType)
        {
        ...
        public UnRegisterTravelCardResponse UnregisterTravelCard_RemoveRelationships(Guid customerId, AccountCategoryCode customerType, string travelCardNumber)
        {
