...
namespace CGIXrmCreateCaseService.Case
{
    public class CreateCaseManager
    {
        ...
        private void UpdateContactFieldsIfOriginalFieldsAreNull(AutoRgCaseRequest request, Account customer)
        {
            ...
            if (string.IsNullOrEmpty(customer?.Address1_line1) && !string.IsNullOrEmpty(request.CustomerAddress1Line1))
                origContact.Attributes.Add("address1_line1", request.CustomerAddress1Line1);

            if (string.IsNullOrEmpty(customer?.Address1_line2) && !string.IsNullOrEmpty(request.CustomerAddress1Line2))
                origContact.Attributes.Add("address1_line2", request.CustomerAddress1Line2);

            if (string.IsNullOrEmpty(customer?.Address1_city) && !string.IsNullOrEmpty(request.CustomerAddress1City))
                origContact.Attributes.Add("address1_city", request.CustomerAddress1City);

            if (string.IsNullOrEmpty(customer?.Address1_postalcode) && !string.IsNullOrEmpty(request.CustomerAddress1Postalcode))
                origContact.Attributes.Add("address1_postalcode", request.CustomerAddress1Postalcode);

            if (string.IsNullOrEmpty(customer?.Address1_country) && !string.IsNullOrEmpty(request.CustomerAddress1Country))
        ...
        private Guid CreateIncidentRgol(AutoRgCaseRequest request, Account customer)
        {
            ...
            if (!string.IsNullOrEmpty(request.CustomerTelephonenumber))
            {
                incident.Attributes.Add("cgi_rgol_telephonenumber", request.CustomerTelephonenumber);
            }
        ...
        private Guid CreateCustomerRgol(AutoRgCaseRequest request)  //TODO: This private method is never used? Delete (Last check 2016-03-13)
        {
            ...
            if (!string.IsNullOrEmpty(request.CustomerFirstName))
                customerEntity.Attributes.Add("firstname", request.CustomerFirstName);

            if (!string.IsNullOrEmpty(request.CustomerLastName))
                customerEntity.Attributes.Add("lastname", request.CustomerLastName);
