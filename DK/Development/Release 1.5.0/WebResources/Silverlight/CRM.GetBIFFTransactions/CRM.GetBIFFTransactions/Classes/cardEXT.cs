  ...
  public class cardEXT : XrmBaseNotify {
	...
	public string Latestfailedattempt {
	  ...
	  set { _latestfailedattempt = value; 
		OnPropertyChanged("Latestfailedattempt"); }
	}
	...
	private void fetchCallback(System.Collections.ObjectModel.ObservableCollection<setting> settingCollection) {
	  if (settingCollection.Count > 0) {
		...
		System.Windows.Deployment.Current.Dispatcher.BeginInvoke(() => {
          ...
          //System.Windows.Browser.HtmlPage.Window.Navigate(new Uri(stringBuilder.ToString()), ContactId != null ? ContactIdName : AccountIdName, "toolbar=no, status=no, resizable=yes");
          System.Windows.Browser.HtmlPage.Window.Navigate(new Uri(stringBuilder.ToString()), "_parent");
