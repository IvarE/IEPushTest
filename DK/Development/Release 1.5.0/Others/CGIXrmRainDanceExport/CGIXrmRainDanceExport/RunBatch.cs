...
namespace CGIXrmRainDanceExport
{
    public class RunBatch
    {
                    ...
                    try
                    {
                        ...
                        if (refund.Caseid != null)
                        {
                            ...
                            if (contact != null)
                            {
                                if (incident != null)
                                {
                                    string custinfo = _createCustomerRecord(refund, contact);
                                    string inviceinfo = _createInvoiceRecord(refund, contact);
                                    string inforecord = _createInformationRecord(refund, contact, incident);
        ...
        private string _createCustomerRecord(refund refund, contact contact)
        {
            ...
            string line = string.Format("{0}{1}{2}{3}{4}{5}{6}", line1, line2, line3, line4, line5, line6, line7);
            return line;
        }
        ...
        private string _createInvoiceRecord(refund refund, contact contact)
        {
            ...
            string line7 = _calculatenetamount(refund.Amount, refund.Vat_code_name).SetToFixedLengthPadRight(16); //ex moms
