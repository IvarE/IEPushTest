    ...
    public class ReimbursementHandler
    {
        ...
        public bool ExecuteRefundTransaction(Entity refund, bool isAutomatic, IOrganizationService service)
        {
            try
            {
                ...
                Entity reimbursementForm = service.Retrieve(rfId.LogicalName, rfId.Id, new ColumnSet("cgi_loadcard", "cgi_giftcard", "cgi_couponsms", "cgi_couponemail", "cgi_payment", "cgi_payment_abroad", "cgi_print"));
                ...
                else if (reimbursementForm.RefundedViaGiftCard())
                {
                    ...
                    DateTime cgiLastValid = DateTime.Now.AddMonths(6);
                    ...
                    CreateGiftcard(customerId, emailAddress, cgiLastValid, amount, erRefund, settingCgiGiftcardservice, settingCgiSendvaluecodemailservice, ref valueCode, service, isAutomatic);
                }
                else if (reimbursementForm.RefundedViaSms())
                {
        ...
        private void CreateGiftcard(EntityReference customerId, string emailAddress, DateTime cgiLastValid, decimal cgiAmount, EntityReference refundEr, string createGiftcardServiceUrl, string sendValueCodeMailServiceUrl, ref string valueCode, IOrganizationService service, bool isAutomatic)
        {
            try
            {
