...
namespace CRM2013.SkanetrafikenPlugins.Common
{
    ...
    public static class TravelInformationHandler
    {
        ...
        public static Entity CreateCaseWithUpdatedTravelInformation(Entity travelInformation)
        {
            ...
            crmCase["cgi_travelinformationline"] = String.IsNullOrWhiteSpace(travelInformation.GetValue<string>("cgi_trainnumber")) ? travelInformation.GetValue<string>("cgi_line") : travelInformation.GetValue<string>("cgi_trainnumber");
            ...
            crmCase["cgi_travelinformationlinedesignation"] = travelInformation.GetValue<string>("cgi_linedesignation");
            crmCase["cgi_travelinformationtrainnumber"] = travelInformation.GetValue<string>("cgi_trainnumber");
            crmCase["cgi_travelinformationjourneynumber"] = travelInformation.GetValue<string>("cgi_journeynumber");
        ...
        public static Entity CreateCaseWithEmptyTravelInformation(Entity travelInformation)
        {
            ...
            crmCase["cgi_travelinformationlinedesignation"] = null;
            crmCase["cgi_travelinformationtrainnumber"] = null;
            crmCase["cgi_travelinformationjourneynumber"] = null;
