...
namespace Endeavor.Crm.UnitTest
{
    ...
    public class TestSetup
    {
        ...
        public void SetupConfig()
        {
            ...
            string username = Skanetrafiken.UnitTest.Properties.Settings.Default.UserName;

            if (!Skanetrafiken.UnitTest.Properties.Settings.Default.UseDefaultCredentials)
            {
            ...
            if (_config == null)
            {
                ...
                _config.DiscoveryUri = new Uri(Skanetrafiken.UnitTest.Properties.Settings.Default.DiscoveryUri);
                _config.EndpointType = (AuthenticationProviderType)Enum.Parse(typeof(AuthenticationProviderType), Skanetrafiken.UnitTest.Properties.Settings.Default.EndpointType);
                if (!string.IsNullOrEmpty(Skanetrafiken.UnitTest.Properties.Settings.Default.HomeRealmUri))
                    _config.HomeRealmUri = new Uri(Skanetrafiken.UnitTest.Properties.Settings.Default.HomeRealmUri);
                _config.OrganizationName = Skanetrafiken.UnitTest.Properties.Settings.Default.OrganizationName;
                _config.OrganizationUri = new Uri(Skanetrafiken.UnitTest.Properties.Settings.Default.OrganizationUri);
                _config.ServerAddress = Skanetrafiken.UnitTest.Properties.Settings.Default.ServerAddress;
                ...
                if (_config.EndpointType == AuthenticationProviderType.ActiveDirectory)
                {
                    ...
                    if (!Skanetrafiken.UnitTest.Properties.Settings.Default.UseDefaultCredentials)
                        cred = new System.Net.NetworkCredential(user.Item1, user.Item2, Skanetrafiken.UnitTest.Properties.Settings.Default.Domain);
