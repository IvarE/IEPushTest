...
select
    ...
    [AccountBase].[cgi_Membership],
    [AccountBase].[cgi_SocialSecurityNumber],
    [AccountBase].[cgi_DebtCollection],
    [AccountBase].[cgi_CustomerType],
    [AccountBase].[cgi_ImportID],
    [AccountBase].[cgi_FirstName],
    [AccountBase].[cgi_LastName],
    [AccountBase].[cgi_NewsLetter],
    [AccountBase].[cgi_allow_autoload],
    [AccountBase].[cgi_max_cards_autoload],
    [AccountBase].[cgi_organizational_number],
    [AccountBase].[cgi_organization_sub_number],
    [AccountBase].[cgi_activated],
    [AccountBase].[cgi_addressid],
    [AccountBase].[cgi_responsibility],
    [AccountBase].[cgi_counterpart],
    [AccountBase].[cgi_rsid],
    [AccountBase].[cgi_MyAccount],
    [AccountBase].[cgi_hasepiserveraccount],
    [AccountBase].[cgi_MyAccount_LastLogin]
from [AccountBase] 
