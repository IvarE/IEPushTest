...
namespace CGIXrmHandler.Shared
{
    internal class XrmHelper
    {
        ...
        internal XrmManager GetXrmManagerFromAppSettings(Guid callerId)
        {
            ...
            {   
                ...
                else
                {
                    ...
                    {
                        ((OrganizationServiceProxy)xrmManager.Service).CallerId = callerId;
            ...
            {
                throw new Exception("Error while initiating XrmManager. Please check the web settings. Err: " + ex.Message);
            }
        }
        ...
        internal XrmManager GetXrmManagerFromAppSettings()
        {
            ...
            {
                throw new Exception("Error while initiating XrmManager. Please check the web settings. Err: " + ex.ToString());
            }
        }
