    ...
    public class TravelCardManager : Response
    {
        ...
        public RegisterTravelCardResponse RegisterTravelCard_CreateOrUpdate(Models.TravelCard travelCard)
        {
            ...
            catch (FaultException<OrganizationServiceFault> ex)
            {
                ...
                _log.Error("ExceptionMsg + " + exceptionMsg + ". IsDuplicateEmail. Ex: " + ex + ". Portal Web Service");
            ...
            catch (TimeoutException ex)
            {
                ...
                //_log2Crm.Exception(exceptionMsg, "IsDuplicateEmail", ex, "Portal Web Service");
                _log.Error("ExceptionsMsg: " + exceptionMsg + ". IsDuplicateEmail, Ex: " + ex + ". Portal Web Service");
                regTravelCardResponse.Status = ProcessingStatus.FAILED;
                regTravelCardResponse.Message = exceptionMsg;
                //_createLogfile(ex.Message);
            }
