...
{
    public class OrderHeader_ViewObject : XrmBaseNotify
    {
        ...
        private ObservableCollection<OrderRow_ViewObject> _OrderItems;
        public ObservableCollection<OrderRow_ViewObject> OrderItems
        {
            get { return _OrderItems; }
            set { _OrderItems = value; OnPropertyChanged("OrderItems"); }
        }

        private ObservableCollection<Payment_ViewObject> _Payments;
        public ObservableCollection<Payment_ViewObject> Payments
        {
