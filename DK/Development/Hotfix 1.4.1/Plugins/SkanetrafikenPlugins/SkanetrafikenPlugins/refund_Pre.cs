        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                if (_data.Context.InputParameters.Contains("Target") && _data.Context.InputParameters["Target"] is Entity)
                {
                    ...
                    if (_data.Target.Contains("cgi_refundtypeid") && _data.Target["cgi_refundtypeid"] != null)
                    {
                        EntityReference refundTypeid = _data.Target.GetAttributeValue<EntityReference>("cgi_refundtypeid");
                        Entity refundType = _data.Service.Retrieve("cgi_refundtype", refundTypeid.Id, new ColumnSet(new string[] { "cgi_refundtypename" }));
                        ...
                        if (refundType != null && refundType.Attributes.TryGetValue("cgi_refundtypename", out refundTypeName))
                        {
                            ...
                            {
                                int valueCodeValidForMonths = Utilities.GetSetting<int>(_data.Service, "cgi_valuecodevalidformonths");
                                _data.Target.Attributes["cgi_last_valid"] = DateTime.Now.AddMonths(valueCodeValidForMonths);
                            }
                        }
                    }
                    ...
                    else
                    {
                        ...
                        if (!(_data.Target.Contains("cgi_vat_code") && _data.Target["cgi_vat_code"] != null))
                        {
