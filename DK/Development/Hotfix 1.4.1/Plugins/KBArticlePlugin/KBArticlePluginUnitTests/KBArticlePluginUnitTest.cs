...
namespace CGI.CRM2013.Skanetrafiken.KBArticlePluginUnitTests
{
    [TestClass]
    public class KbArticlePluginUnitTest
    {
        ...
        private readonly KBArticlePlugin.KBArticlePlugin _kbArticlePlugin;
        ...
        public KbArticlePluginUnitTest()
        {
            ...
            _kbArticlePlugin = new KBArticlePlugin.KBArticlePlugin();
        }
        ...
        /// </summary>
        [TestMethod]
        public void GetKbArticleIntranet()
        {
            var query = new QueryExpression("kbarticle");
        ...
        /// </summary>
        [TestMethod]
        public void GetKbArticleExternalWeb()
        {
            var query = new QueryExpression("kbarticle");
            query.ColumnSet.AddColumns(
                "title", 
