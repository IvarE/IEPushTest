...
if(@f=0)begin
insert into @t(o,t,c)select o.st_update_travelcardId,10058,36 from st_update_travelcard o,@c c where c.t=10027 and c.o=o.st_CardNum
insert into @t(o,t,c)select o.cgi_travelcardtransactionId,10028,43 from cgi_travelcardtransaction o,@c c where c.t=10027 and c.o=o.cgi_TravelCardid
insert into @t(o,t,c)select o.st_discountcodeId,10063,42 from st_discountcode o,@c c where c.t=10027 and c.o=o.st_TravelCard
end goto a end
if(@y=4300 and @f=0)begin
insert into @t(o,t,c)select o.st_externallistId,10059,37 from st_externallist o,@c c where c.t=4300 and c.o=o.st_MarketingList
goto a end
if(@y=10030)begin
...
if(@f=0)insert into @t(o,t,c)select o.st_discountcodeId,10063,40 from st_discountcode o,@c c where c.t=4400 and c.o=o.st_Campaign
goto a end
if(@y=1)begin
...
insert into @t(o,t,c)select o.st_externallistId,10059,34 from st_externallist o,@c c where c.t=2 and c.o=o.st_ContactLookup
insert into @t(o,t,c)select o.st_discountcodeId,10063,34 from st_discountcode o,@c c where c.t=2 and c.o=o.st_Contact
...
if(@f=0)insert into @t(o,t,c)select o.st_discountcodeId,10063,37 from st_discountcode o,@c c where c.t=4 and c.o=o.st_Lead
goto a end
if(@y=3)begin
...
goto a end
a:
if(@y in(1,2,3,4,112,1010,1084,1088,1090,4400,4402,4406,9700,9702,10000,10014,10025,10027,10058,10059,10063))
...
if(@y in(10014,10000,10059,10027,10063,10025,10058))
insert into @t(o,t,c)select o.ActivityId,4214,32 from ServiceAppointment o,@c c where c.t=@y and c.o=o.RegardingObjectId and o.RegardingObjectTypeCode=@y
if(@y in(10000,10058,10063,10025,10014,10027,10059))
...
if(@y in(10059,10000,10014,10063,10058,10025,10027))
...
if(@y in(10063,10027,10025,10059,10058,10014,10000))
...
if(@y in(10000,10014,10063,10027,10058,10059,10025))
...
if(@y in(10058,10027,10014,10000,10059,10025,10063))
...
if(@y in(10063,10027,10058,10059,10014,10000,10025))
...
if(@y in(10059,10027,10014,10000,10025,10058,10063))
...
if(@y in(10059,10058,10063,10000,10014,10027,10025))
...
if(@y in(10000,10027,10014,10059,10025,10063,10058))
...
if(@y in(10000,10058,10027,10014,10059,10063,10025))
