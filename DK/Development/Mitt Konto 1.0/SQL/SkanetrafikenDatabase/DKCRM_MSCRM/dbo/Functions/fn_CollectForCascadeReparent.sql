...
if(exists(select * from @t where t in(1090,10027,4700,10000,1010,4406,10014,3,1088,2,9700,10064,1,1084,112,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4216,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from SocialActivity o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,4700,10000,1010,4406,10014,3,1088,2,9700,10064,1,1084,112,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4210,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from PhoneCall o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,10014,3,1088,2,4400,9700,10064,1,1084,112,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4214,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from ServiceAppointment o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,10014,3,1088,2,4400,9700,10064,1,1084,112,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4212,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from Task o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4201,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from Appointment o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4207,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from Letter o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(1090,10027,4700,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4202,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from Email o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,4700,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4204,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from Fax o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,4251,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from RecurringAppointmentMaster o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,9700,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,10009,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from cgi_callguidefacebook o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,10064,1,1084,112,4402,10025,4)))begin insert into @t(o,t,u,v,q,s,l) select o.ActivityId,10008,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from cgi_callguidechat o,@t c where o.RegardingObjectId=c.o and c.t in(1090,10027,10000,1010,4406,10014,3,1088,2,4400,10064,1,1084,112,4402,10025,4) end
if(exists(select * from @t where t in(10008,10009,4251,1090,4204,10027,4202,10000,4206,9605,1010,4300,10019,3,9606,4703,4401,4207,4209,9300,4201,9750,1088,4216,4208,2,4400,4414,8181,9700,9507,10064,9600,4211,4212,1,1084,112,4402,4214,10025,4,4210)))begin insert into @t(o,t,u,v,q,s,l) select o.AnnotationId,5,o.OwnerId, o.OwnerIdType, c.o, c.t, c.l +1 from Annotation o,@t c where o.ObjectId=c.o and c.t in(10008,10009,4251,1090,4204,10027,4202,10000,4206,9605,1010,4300,10019,3,9606,4703,4401,4207,4209,9300,4201,9750,1088,4216,4208,2,4400,4414,8181,9700,9507,10064,9600,4211,4212,1,1084,112,4402,4214,10025,4,4210) end
return
end
