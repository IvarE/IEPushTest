...
select
    ...
    [SystemUser].[cgi_attestid],
    [SystemUser].[cgi_CallguideUsername],
    [SystemUser].[cgi_EmailPhrase],
    [SystemUser].[cgi_noqueueassign],
    [SystemUser].[cgi_RSID],
