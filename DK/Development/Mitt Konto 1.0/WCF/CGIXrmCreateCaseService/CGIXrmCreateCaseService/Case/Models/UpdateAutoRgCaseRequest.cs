...
namespace CGIXrmCreateCaseService.Case.Models
{
    ...
    public class UpdateAutoRgCaseRequest
    {
        ...
        [DataMember]
        public decimal CompensationClaimFromRGOL { get; set; }// save as cgi_compensationclaimfromrgol on the case

        [DataMember]
        public string RGOLCaseLog { get; set; } //saved as cgi_rgolcaselog on the case
