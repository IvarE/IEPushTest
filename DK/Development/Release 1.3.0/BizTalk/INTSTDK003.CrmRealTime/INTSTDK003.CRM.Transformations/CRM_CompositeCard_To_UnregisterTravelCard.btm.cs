namespace INTSTDK003.CRM.Transformations {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"INTSTDK003.CRM.Schemas.External.UnregisterTravelCardResponse", typeof(global::INTSTDK003.CRM.Schemas.External.UnregisterTravelCardResponse))]
    ...
    public sealed class CRM_CompositeCard_To_UnregisterTravelCard : global::Microsoft.XLANGs.BaseTypes.TransformBase {
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 s1"" version=""1.0"" xmlns:s1=""http://tempuri.org/"" xmlns:s0=""http://schemas.datacontract.org/2004/07/CGICRMPortalService.Models"" xmlns:ns0=""http://www.skanetrafiken.se/INSTDK003.22.CrmRealTime"">
  ...
  <xsl:template match=""/"">
    <xsl:apply-templates select=""/s1:UnregisterTravelCardResponse"" />
  </xsl:template>
  <xsl:template match=""/s1:UnregisterTravelCardResponse"">
    <ns0:crmCardResponse>
      <xsl:for-each select=""s1:UnregisterTravelCardResult"">
        <ns0:status>
        ...
        private const string _strSrcSchemasList0 = @"INTSTDK003.CRM.Schemas.External.UnregisterTravelCardResponse";
        
        private const global::INTSTDK003.CRM.Schemas.External.UnregisterTravelCardResponse _srcSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"INTSTDK003.CRM.Schemas.External.UnregisterTravelCardResponse";
                return _SrcSchemas;
            }
        }
