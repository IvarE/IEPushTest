namespace INTSTDK001.STIP.Transformations {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"INTSTDK001.STIP.Schemas.External.GetDirectJourneysBetweenStopsResponse", typeof(global::INTSTDK001.STIP.Schemas.External.GetDirectJourneysBetweenStopsResponse))]
    public sealed class STIP_GetDirectJourneysBetweenStopsResponse_To_External : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        
        private const string _strMap = @"<?xml version=""1.0"" encoding=""UTF-16""?>
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0"" version=""1.0"" xmlns:ns0=""http://INTSTDK001.CRM.Schemas.GetDirectJourneysBetweenStopsResponse.20140710"" xmlns:s0=""http://INTSTDK001.PubTrans.Schemas.GetDirectJourneysBetweenStopsResponse.20140710"">
  <xsl:output omit-xml-declaration=""yes"" method=""xml"" version=""1.0"" />
  <xsl:template match=""/"">
    <xsl:apply-templates select=""/s0:GetDirectJourneysBetweenStopsResponse"" />
  </xsl:template>
  <xsl:template match=""/s0:GetDirectJourneysBetweenStopsResponse"">
    <ns0:GetDirectJourneysBetweenStopsResponse>
      <xsl:for-each select=""DirectJourneysBetweenStops"">
      ...
      <xsl:for-each select=""DeviationMessageVersion"">
      ...
      <xsl:for-each select=""DeviationMessageVariant"">
      ...
      <xsl:for-each select=""ServiceJourneyDeviation"">
      ...
      <xsl:for-each select=""DepartureDeviation"">
        <DepartureDeviation>
          <xsl:if test=""Id"">
            <Id>
              <xsl:value-of select=""Id/text()"" />
      ...
      <xsl:for-each select=""ArrivalDeviation"">
        <ArrivalDeviation>
          <xsl:if test=""Id"">
            <Id>
              <xsl:value-of select=""Id/text()"" />
      ...
      <xsl:for-each select=""TargetAudience"">
        <TargetAudience>
        ...
        private const string _strSrcSchemasList0 = @"INTSTDK001.PubTrans.Schemas.Internal.GetDirectJourneysBetweenStopsResponse";
        
        private const global::INTSTDK001.PubTrans.Schemas.Internal.GetDirectJourneysBetweenStopsResponse _srcSchemaTypeReference0 = null;
        
        private const string _strTrgSchemasList0 = @"INTSTDK001.STIP.Schemas.External.GetDirectJourneysBetweenStopsResponse";
        
        private const global::INTSTDK001.STIP.Schemas.External.GetDirectJourneysBetweenStopsResponse _trgSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"INTSTDK001.PubTrans.Schemas.Internal.GetDirectJourneysBetweenStopsResponse";
                return _SrcSchemas;
            }
        }
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"INTSTDK001.STIP.Schemas.External.GetDirectJourneysBetweenStopsResponse";
                return _TrgSchemas;
            }
        }
    }
