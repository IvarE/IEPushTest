...
namespace CGIXrmRainDanceExport
{
    public class RunBatch
    {
        ...
        private string _createCustomerRecord(refund refund, contact contact)
        {
            ...
            string _line5 = string.Format("{0}  {1}", _formatString(contact.Address1_postalcode).SetMaxLength(6), _formatString(contact.Address1_city)).SetToFixedLengthPadRight(30);
            string _line6 = "1500".SetToFixedLengthPadRight(12);
            string _line7 = "".SetToFixedLengthPadRight(16);         // "99".PadLeft(16, '0');
        ...
        private string _createInvoiceRecord(refund refund, contact contact)
        {
            ...
            string _line7 = _calculatenetamount(refund.Amount, refund.Vat_code_name).SetToFixedLengthPadRight(16); //ex moms
