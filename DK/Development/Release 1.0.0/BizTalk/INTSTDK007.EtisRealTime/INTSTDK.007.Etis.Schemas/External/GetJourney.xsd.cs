namespace INTSTDK007.Etis.Schemas.External {
    ...
    [SchemaRoots(new string[] {@"GetJourney", @"GetJourneyResponse"})]
...
<xs:schema xmlns=""http://www.etis.fskab.se/v1.0/ETISws"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" elementFormDefault=""qualified"" targetNamespace=""http://www.etis.fskab.se/v1.0/ETISws"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""JourneyDateTime"" type=""xs:dateTime"">
          <xs:annotation>
            <xs:documentation>[Optional] Date and time for journey (yyyy-mm-dd hh:mm:ss), the default is current datetime
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""NoOfJourneysBefore"" type=""xs:int"">
          <xs:annotation>
            <xs:documentation>[Optional] No of journey alternatives in result before the searched DateTime, the default is 1
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""NoOfJourneysAfter"" type=""xs:int"">
          <xs:annotation>
            <xs:documentation>[Optional] No of journey alternatives in result after the searched DateTime, the default is 3
              <xs:restriction base=""xs:positiveInteger""><xs:minInclusive value=""0"" /><xs:maxInclusive value=""10"" /></xs:restriction></xs:documentation>
          </xs:annotation>
        </xs:element>
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""MaxWalkDistance"" type=""xs:int"">
          <xs:annotation>
            <xs:documentation>[Optional] Max walk distance in meters, the default is 3000
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""DetailedResult"" type=""xs:boolean"">
          <xs:annotation>
            <xs:documentation>[Optional] Denotes if detailed itinerary (PointsOnRouteLink) should be included in results, the default is False - without PointsOnRouteLink info
      ...
      <xs:sequence>
          ...
          <xs:complexType>
            <xs:sequence>
              ...
              <xs:element name=""Message"" type=""xs:string"">
                <xs:annotation>
                  <xs:documentation>Error message, empty if response code = 0</xs:documentation>
                </xs:annotation>
              </xs:element>
                    ...
                    <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""Journey"">
                      <xs:complexType>
                        <xs:sequence>
                          ...
                          <xs:element name=""DepDateTime"" type=""xs:dateTime"">
                            <xs:annotation>
                              <xs:documentation>Departure date and time. </xs:documentation>
                            </xs:annotation>
                          </xs:element>
                          <xs:element name=""ArrDateTime"" type=""xs:dateTime"">
                            <xs:annotation>
                              <xs:documentation>Arrival date and time.</xs:documentation>
                            </xs:annotation>
                          </xs:element>
                          <xs:element name=""DepWalkDist"" type=""xs:int"">
                            <xs:annotation>
                          ...
                          <xs:element name=""ArrWalkDist"" type=""xs:int"">
                            <xs:annotation>
                          ...
                          <xs:element name=""NoOfChanges"" type=""xs:int"">
                            <xs:annotation>
                          ...
                          <xs:element name=""CO2factor"" type=""xs:int"">
                            <xs:annotation>
                        ...
                        <xs:restriction base=""xs:positiveInteger""><xs:minInclusive value=""0"" /><xs:maxInclusive value=""100"" /></xs:restriction></xs:documentation>
                          ...
                          <xs:element name=""NoOfZones"" type=""xs:int"">
                            <xs:annotation>
                                ...
                                <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""PriceInfo"">
                                  <xs:complexType>
                                    <xs:sequence>
                                      ...
                                      <xs:element minOccurs=""0"" name=""JourneyTicketKey"" type=""xs:string"">
                                        <xs:annotation>
                                          <xs:documentation>Unique ticket key</xs:documentation>
                                        </xs:annotation>
                                      </xs:element>
                                      <xs:element minOccurs=""0"" name=""Counties"">
                                        <xs:complexType>
                                          <xs:sequence>
                          ...
                          <xs:element name=""JourneyKey"" type=""xs:string"">
                            <xs:annotation>
                          ...
                          <xs:element name=""RouteLinks"">
                            <xs:complexType>
                              <xs:sequence>
                                <xs:element maxOccurs=""unbounded"" name=""RouteLink"">
                                  <xs:complexType>
                                    <xs:sequence>
                                      <xs:element name=""RouteLinkKey"" type=""xs:string"">
                                        <xs:annotation>
                                      ...
                                      <xs:element name=""DepIsTimingPoint"" type=""xs:boolean"">
                                        <xs:annotation>
                                      ...
                                      <xs:element name=""ArrIsTimingPoint"" type=""xs:boolean"">
                                        <xs:annotation>
                                            ...
                                            <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""RealTimeInfo"">
                                              <xs:complexType>
                                                <xs:sequence>
                                                  ...
                                                  <xs:element minOccurs=""0"" name=""DepDeviationAffect"" type=""RealTimeAffect"">
                                                    <xs:annotation>
                                                      <xs:documentation>Describes how departure time deviation affects the journey.</xs:documentation>
                                                    </xs:annotation>
                                                  </xs:element>
                                                  <xs:element minOccurs=""0"" name=""ArrTimeDeviation"" type=""xs:int"">
                                                    <xs:annotation>
                                                  ...
                                                  <xs:element minOccurs=""0"" name=""ArrDeviationAffect"" type=""RealTimeAffect"">
                                                    <xs:annotation>
                                            ...
                                            <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""RealTimeRoadInfo"">
                                              ...
                                              <xs:complexType>
                                                <xs:sequence>
                                                  ...
                                                  <xs:element name=""Reason"" type=""RoadInfoType"">
                                                    <xs:annotation>
                                      ...
                                      <xs:element name=""From"">
                                        <xs:complexType>
                                          <xs:sequence>
                                            ...
                                            <xs:element name=""StopPoint"" type=""xs:string"">
                                              <xs:annotation>
                                      ...
                                      <xs:element name=""Line"">
                                        <xs:complexType>
                                          <xs:sequence>
                                            ...
                                            <xs:element minOccurs=""0"" name=""RunNo"" type=""xs:int"">
                                              <xs:annotation>
                                                <xs:documentation>Line's run number</xs:documentation>
                                              </xs:annotation>
                                            </xs:element>
                                            <xs:element name=""LineTypeId"" type=""xs:int"">
                                              <xs:annotation>
                                            ...
                                            <xs:element name=""LineTypeName"" type=""xs:string"">
                                              <xs:annotation>
                                                <xs:documentation>Line type name</xs:documentation>
                                              </xs:annotation>
                                            </xs:element>
                                            <xs:element name=""TransportModeId"" type=""xs:int"">
                                              <xs:annotation>
                                            ...
                                            <xs:element name=""TransportModeName"" type=""xs:string"">
                                              <xs:annotation>
                                            ...
                                            <xs:element minOccurs=""0"" name=""Towards"" type=""xs:string"">
                                              <xs:annotation>
                                            ...
                                            <xs:element minOccurs=""0"" name=""PointsOnRouteLink"">
                                              <xs:annotation>
                                        ...
                                        <xs:complexType>
                                          <xs:sequence>
                                            <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""Deviation"">
                                              <xs:complexType>
                                                <xs:sequence>
                                                  <xs:element name=""DeviationScopes"">
                                                    <xs:complexType>
                                                      <xs:sequence>
                                                        <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""DeviationScope"">
                                                          <xs:complexType>
                                                            <xs:sequence>
                                                              <xs:element maxOccurs=""unbounded"" name=""ScopeAttribute"" type=""ScopeAttributeType"" />
                                                  ...
                                                  <xs:element name=""Influence"" type=""xs:int"" />
                                      ...
                                      <xs:element minOccurs=""0"" name=""Accessibility"" type=""xs:int"">
                                        <xs:annotation>
                          ...
                          <xs:element name=""CO2value"" type=""xs:float"">
                            <xs:annotation>
                              <xs:documentation>
                          ...
                          <xs:element minOccurs=""0"" name=""Recalculated"" type=""xs:boolean"">
                            <xs:annotation>
                              <xs:documentation>
                          ...
                          <xs:element minOccurs=""0"" name=""OriginalTime"" type=""xs:string"">
                            <xs:annotation>
                              <xs:documentation>
                          ...
                          <xs:element name=""SalesRestriction"" type=""xs:string"">
                            <xs:annotation>
                              <xs:documentation>
                          ...
                          <xs:element name=""PriceZoneNamesList"" type=""xs:string"">
                            <xs:annotation>
                              <xs:documentation>
                          ...
                          <xs:element name=""StartEndBigZoneList"" type=""xs:string"">
                            <xs:annotation>
                              <xs:documentation>
        ...
        public override string[] RootNodes {
            get {
                ...
                _RootElements[1] = "GetJourneyResponse";
        ...
        [Schema(@"http://www.etis.fskab.se/v1.0/ETISws",@"GetJourney")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://www.etis.fskab.se/v1.0/ETISws",@"GetJourneyResponse")]
        [System.SerializableAttribute()]
        [SchemaRoots(new string[] {@"GetJourneyResponse"})]
        public sealed class GetJourneyResponse : Microsoft.XLANGs.BaseTypes.SchemaBase {
            ...
            public override string[] RootNodes {
                get {
                    string[] _RootElements = new string [1];
                    _RootElements[0] = "GetJourneyResponse";
                    return _RootElements;
                }
            }
