namespace INTSTDK003.CRM.Transformations {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"INTSTDK003.CRM.Schemas.External.PortalService+CreateCustomer", typeof(global::INTSTDK003.CRM.Schemas.External.PortalService.CreateCustomer))]
    public sealed class CRM_CompositeRequest_To_CreateCustomer : global::Microsoft.XLANGs.BaseTypes.TransformBase {
  ...
  <xsl:template match=""/s0:crmCustomerRequest"">
    <ns0:CreateCustomer>
      <xsl:for-each select=""s0:setAccount"">
        ...
        private const string _strTrgSchemasList0 = @"INTSTDK003.CRM.Schemas.External.PortalService+CreateCustomer";
        
        private const global::INTSTDK003.CRM.Schemas.External.PortalService.CreateCustomer _trgSchemaTypeReference0 = null;
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"INTSTDK003.CRM.Schemas.External.PortalService+CreateCustomer";
                return _TrgSchemas;
            }
        }
    }
