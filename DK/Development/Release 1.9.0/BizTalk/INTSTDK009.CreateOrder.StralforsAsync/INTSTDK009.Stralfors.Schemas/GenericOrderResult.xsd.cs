namespace INTSTDK009.Stralfors.Schemas {
    ...
    [Schema(@"",@"Orders")]
    [BodyXPath(@"/*[local-name()='Orders' and namespace-uri()='']")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"Orders"})]
    public sealed class GenericOrderResult : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" id=""Orders"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  ...
  <xs:element name=""Orders"">
    <xs:annotation>
      <xs:appinfo>
        <b:recordInfo body_xpath=""/*[local-name()='Orders' and namespace-uri()='']"" />
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
          ...
          <xs:complexType>
            <xs:sequence>
              ...
              <xs:choice minOccurs=""0"">
                <xs:element minOccurs=""0"" maxOccurs=""1"" name=""ShippingAdress"">
                  <xs:complexType>
                    <xs:sequence>
                ...
                <xs:element minOccurs=""0"" maxOccurs=""1"" name=""ShippingAddress"">
                  <xs:complexType>
                    <xs:sequence>
                      <xs:element minOccurs=""0"" name=""Name"" type=""xs:string"" />
                      <xs:element minOccurs=""0"" name=""ContactPerson"" type=""xs:string"" />
              ...
              <xs:element minOccurs=""0"" maxOccurs=""1"" name=""PacketDesc"">
                <xs:complexType>
                  <xs:sequence>
