...
select
    -- logical attributes
    [cgi_cgi_callguideinfo_phonecall_CallguideInfoid].[cgi_callguideinfoname],
    ...
    [PhoneCallBase].[cgi_CreateCase],
    [PhoneCallBase].[cgi_CallguideInfoid]
from [ActivityPointerBase] 
    inner join [PhoneCallBase] on ([ActivityPointerBase].[ActivityId] = [PhoneCallBase].[ActivityId] and [ActivityPointerBase].[ActivityTypeCode] = 4210)
    left join [cgi_callguideinfoBase] [cgi_cgi_callguideinfo_phonecall_CallguideInfoid] on ([PhoneCallBase].[cgi_CallguideInfoid] = [cgi_cgi_callguideinfo_phonecall_CallguideInfoid].[cgi_callguideinfoId])
