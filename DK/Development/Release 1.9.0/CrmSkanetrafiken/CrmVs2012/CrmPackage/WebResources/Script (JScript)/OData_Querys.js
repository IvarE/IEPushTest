...
CGISweden.odata =
{
    ...
    //MaxP 2016-03-01 ytterligare en kolumner som returneras i svaret. Ursprung, ärendetyp och flagga för manuella ärenden
    GetCaseNumber: function (caseid, CallBackFunction, CompleteFunction) {
        try {
            var _options = "$select=TicketNumber,cgi_UnregisterdTravelCard,CaseOriginCode,CaseTypeCode,cgi_iscompleted,cgi_milagekilometers,cgi_milagelicenseplatenumber,cgi_milagefrom,cgi_milageto,cgi_taxifrom,cgi_taxito,cgi_taxiclaimedamount,cgi_RefundTypes,cgi_RefundReimbursementForm&";
