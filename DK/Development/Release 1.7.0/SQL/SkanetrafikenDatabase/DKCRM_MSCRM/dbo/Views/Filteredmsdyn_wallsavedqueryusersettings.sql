...
select
    ...
    dbo.fn_UTCToTzSpecificLocalTime([msdyn_wallsavedqueryusersettings].[CreatedOn], 
			us.TimeZoneBias,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([msdyn_wallsavedqueryusersettings].[ModifiedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([msdyn_wallsavedqueryusersettings].[OverriddenCreatedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
