...
select
    ...
    dbo.fn_UTCToTzSpecificLocalTime([msdyn_wallsavedquery].[CreatedOn], 
			us.TimeZoneBias,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([msdyn_wallsavedquery].[ModifiedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([msdyn_wallsavedquery].[OverriddenCreatedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
