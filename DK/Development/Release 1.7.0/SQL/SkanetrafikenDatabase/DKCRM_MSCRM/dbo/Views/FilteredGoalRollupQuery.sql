...
select
    ...
    dbo.fn_UTCToTzSpecificLocalTime([GoalRollupQuery].[CreatedOn], 
			us.TimeZoneBias,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([GoalRollupQuery].[ModifiedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
    ...
    dbo.fn_UTCToTzSpecificLocalTime([GoalRollupQuery].[OverriddenCreatedOn], 
			us.TimeZoneBias,
			us.TimeZoneDaylightBias,
			us.TimeZoneDaylightYear,
			us.TimeZoneDaylightMonth,
