        ...
        public bool ExecuteRefundTransaction(Entity refund, bool isAutomatic, IOrganizationService service)
        {
            try
            {
                ...
                else if (reimbursementForm.RefundedViaGiftCard())
                {
                    ...
                    CreateGiftcard(customerId, emailAddress, IsEmailAdressIdenticalToCustomerEmailAddress, cgiLastValid, amount, erRefund, settingCgiGiftcardservice, settingCgiSendvaluecodemailservice, ref valueCode, service, isAutomatic);
                }
