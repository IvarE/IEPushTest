...
rem 1.8     CGI                              2015-05-21 plockat bort Screenpop från CHAT.
rem 1.9     CGI         2015-08-04 Utökat ScreenPop funktion
rem ************************************************************************
rem 'UTV miljön
...
rem 'UAT miljön
rem 'Const baseURL = "http://sekunduat.skanetrafiken.se:4004/CallGuide/DoAction.aspx" ' base addres for CRM posting '
rem 'Const guidURL = "http://sekunduat.skanetrafiken.se:4004/CallGuide/GetUserGuid.aspx" ' base address to retrieve Agent GUID '

rem 'PROD miljön
Const baseURL = "http://sekund.skanetrafiken.se:4004/CallGuide/DoAction.aspx" ' base addres for CRM posting '
Const guidURL = "http://sekund.skanetrafiken.se:4004/CallGuide/GetUserGuid.aspx" ' base address to retrieve Agent GUID '
