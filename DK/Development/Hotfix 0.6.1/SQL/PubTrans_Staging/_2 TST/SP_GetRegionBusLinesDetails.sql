...
/****** Object:  StoredProcedure [dbo].[SP_GetRegionBusLinesDetails]    Script Date: 2015-04-24 13:02:37 ******/
SET ANSI_NULLS ON
GO
...
select	 	
	...
	A.OperatorCode LineTransportAuthorityCode		
	into #RegionBus
	from 
		LineInZone A		
	where 
	...
	--And
	--(Convert(varchar(10),A.ExistsUptoDate,110)>=Convert(varchar(10),GETDATE(),110 or A.ExistsUptoDate is null)
	--And
	--(Convert(varchar(10),A.ExistsFromDate,110)<=Convert(varchar(10),GETDATE(),110))
	--(Convert(varchar(10),A.ExistsUptoDate,110)>='06-12-2014' or A.ExistsUptoDate is null)
	--And
	--(Convert(varchar(10),A.ExistsFromDate,110)<='06-12-2014')
