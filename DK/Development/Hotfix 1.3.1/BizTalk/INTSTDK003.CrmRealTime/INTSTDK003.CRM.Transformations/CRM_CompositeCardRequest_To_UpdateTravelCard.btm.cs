namespace INTSTDK003.CRM.Transformations {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"INTSTDK003.CRM.Schemas.External.PortalService+UpdateTravelCard", typeof(global::INTSTDK003.CRM.Schemas.External.PortalService.UpdateTravelCard))]
    public sealed class CRM_CompositeCardRequest_To_UpdateTravelCard : global::Microsoft.XLANGs.BaseTypes.TransformBase {
  ...
  <xsl:template match=""/s0:crmCardRequest"">
    <ns0:UpdateTravelCard>
      <xsl:for-each select=""s0:card"">
        ...
        private const string _strTrgSchemasList0 = @"INTSTDK003.CRM.Schemas.External.PortalService+UpdateTravelCard";
        
        private const global::INTSTDK003.CRM.Schemas.External.PortalService.UpdateTravelCard _trgSchemaTypeReference0 = null;
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"INTSTDK003.CRM.Schemas.External.PortalService+UpdateTravelCard";
                return _TrgSchemas;
            }
        }
    }
