...
/****** Object:  StoredProcedure [dbo].[sp_CreateTravelCardImportTable]    Script Date: 2015-04-24 12:42:43 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	into #travelcards
	from DKCRMUAT_MSCRM.dbo.Filteredcgi_travelcard travelcard
	...
	from travelcards
	inner join DKCRMUAT_MSCRM.dbo.FilteredContact contact
