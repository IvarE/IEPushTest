...
/****** Object:  StoredProcedure [dbo].[sp_GetTravelCard]    Script Date: 2015-04-24 11:11:52 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	inner join Skanetrafiken_MSCRM.dbo.FilteredContact contact on travelcard.cgi_contactid = contact.contactid
