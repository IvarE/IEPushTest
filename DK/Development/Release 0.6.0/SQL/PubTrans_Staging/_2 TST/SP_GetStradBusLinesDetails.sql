...
/****** Object:  StoredProcedure [dbo].[SP_GetStradBusLinesDetails]    Script Date: 2015-04-24 13:02:49 ******/
SET ANSI_NULLS ON
GO
...
select 
	...
	(
		select 
			...
			(
				...
				Where
					D.IsOnLineGid=C.Gid
				--And
				--(Convert(varchar(10),D.ExistsUptoDate,110)>=Convert(varchar(10),GETDATE(),110 or D.ExistsUptoDate is null)
				--And
				--(Convert(varchar(10),D.ExistsFromDate,110)<=Convert(varchar(10),GETDATE(),110))
				--(Convert(varchar(10),D.ExistsUptoDate,110)>='06-12-2014' or D.ExistsUptoDate is null)
				--And
				--(Convert(varchar(10),D.ExistsFromDate,110)<='06-12-2014')
		...
		--And
			...
			--(Convert(varchar(10),C.ExistsUptoDate,110)>=Convert(varchar(10),GETDATE(),110 or C.ExistsUptoDate is null)
			--And
			--(Convert(varchar(10),C.ExistsFromDate,110)<=Convert(varchar(10),GETDATE(),110))
			--(Convert(varchar(10),C.ExistsUptoDate,110)>='06-12-2014' or C.ExistsUptoDate is null)
			--And
			--(Convert(varchar(10),C.ExistsFromDate,110)<='06-12-2014')
	...
	where
		...
		(
		 ...
		 Where			
			...
			----(Convert(varchar(10),B.ExistsUptoDate,110)>=Convert(varchar(10),GETDATE(),110 or A.ExistsUptoDate is null)
			----And
			----(Convert(varchar(10),B.ExistsFromDate,110)<=Convert(varchar(10),GETDATE(),110))
			--(Convert(varchar(10),B.ExistsUptoDate,110)>='06-12-2014' or B.ExistsUptoDate is null)
			--And
			--(Convert(varchar(10),B.ExistsFromDate,110)<='06-12-2014')
		)		
	order by ZoneName
