CREATE TABLE [dbo].[ActivityPointerBase] (
    ...
    [ImportSequenceNumber_10008]      INT              NULL,
    [OverriddenCreatedOn_10008]       DATETIME         NULL,
    [ImportSequenceNumber_10009]      INT              NULL,
    [OverriddenCreatedOn_10009]       DATETIME         NULL,
    ...
    CONSTRAINT [activity_pointer_cgi_callguidechat] FOREIGN KEY ([ActivityId]) REFERENCES [dbo].[ActivityPointerBase] ([ActivityId]) NOT FOR REPLICATION,
    CONSTRAINT [activity_pointer_cgi_callguidefacebook] FOREIGN KEY ([ActivityId]) REFERENCES [dbo].[ActivityPointerBase] ([ActivityId]) NOT FOR REPLICATION,
