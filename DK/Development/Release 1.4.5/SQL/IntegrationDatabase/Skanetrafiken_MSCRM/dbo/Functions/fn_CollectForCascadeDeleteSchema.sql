...
goto a end
if(@y=10063)begin
insert into @t(o,t,d)select st_discountcodeId,10063,@n from st_discountcode
goto a end
if(@y=10011)begin
...
goto a end
if(@y=10058)begin
insert into @t(o,t,d)select st_update_travelcardId,10058,@n from st_update_travelcard
goto a end
if(@y=10059)begin
insert into @t(o,t,d)select st_externallistId,10059,@n from st_externallist
goto a end
if(@y=10014)begin
...
a:
set @n=0
if(@y in(10014,10010,10009,10044,10011,10007,10016,10063,10042,10040,10025,10000,10026,10027,10041,10017,10029,10058,10028,10024,10006,10037,10022,10039,10020,10035,10018,10008,10047,10015,10012,10013,10059,10021,10030,10019,10023))
...
if(@y in(10012,10042,10000,10013,10025,10016,10026,10007,10011,10063,10006,10018,10014,10017,10059,10035,10058,10020,10024,10027,10028,10040,10037,10019,10008,10022,10021,10023,10015,10010,10039,10029,10041,10047,10030,10009,10044))
...
if(@y in(10008,10063,10058,10059,10009,10000))
...
if(@y in(10009,10008,10000,10063,10059,10058))
...
if(@y in(10030,10035,10013,10044,10041,10009,10018,10057,10022,10042,10058,10007,10006,10019,10017,10014,10040,10026,10002,10016,10027,10004,10020,10001,10011,10003,10023,10000,10039,10059,10015,10008,10037,10025,10021,10063,10010,10047,10012,10028,10005,10029,10055,10056,10024,10046))
...
if(@y in(10000,10025,10059,10019,10058,10008,10027,10009,10063))
insert into @t(o,t,d)select AnnotationId,5,@n from Annotation where ObjectTypeCode=@y
if(@y in(10005,10037,10041,10028,10063,10004,10047,10035,10002,10057,10042,10013,10012,10040,10018,10025,10001,10010,10055,10029,10023,10000,10011,10058,10059,10027,10017,10046,10016,10019,10014,10008,10015,10026,10020,10009,10030,10056,10044,10007,10024,10022,10021,10006,10039,10003))
