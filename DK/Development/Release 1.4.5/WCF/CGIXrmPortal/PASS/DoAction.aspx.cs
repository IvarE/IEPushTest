    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Request.QueryString.HasKeys())
            {
                ...
                {
                    sFN = string.IsNullOrEmpty(Request.QueryString["sFN"]) ? null : Request.QueryString["sFN"],
                    sLN = string.IsNullOrEmpty(Request.QueryString["sLN"]) ? null : Request.QueryString["sLN"],
                    sA = string.IsNullOrEmpty(Request.QueryString["sA"]) ? null : Request.QueryString["sA"],
                    sPA = string.IsNullOrEmpty(Request.QueryString["sPA"]) ? null : Request.QueryString["sPA"],
                    sPH = string.IsNullOrEmpty(Request.QueryString["sPH"]) ? null : Request.QueryString["sPH"],
                    sPW = string.IsNullOrEmpty(Request.QueryString["sPW"]) ? null : Request.QueryString["sPW"],
                    sPM = string.IsNullOrEmpty(Request.QueryString["sPM"]) ? null : Request.QueryString["sPM"],
                    sPF = string.IsNullOrEmpty(Request.QueryString["sPF"]) ? null : Request.QueryString["sPF"],
                    sEM = string.IsNullOrEmpty(Request.QueryString["sEM"]) ? string.Empty : Request.QueryString["sEM"],
                    sSSN =
                        string.IsNullOrEmpty(Request.QueryString["sSSN"]) ? string.Empty : Request.QueryString["sSSN"],
