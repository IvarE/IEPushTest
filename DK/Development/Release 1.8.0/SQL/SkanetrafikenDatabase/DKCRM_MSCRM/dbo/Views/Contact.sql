...
select
    ...
    [cgi_cgi_representative_contact_Representativeid].[cgi_name],
    ...
    [ContactBase].[cgi_ContactNumber],
    [ContactBase].[cgi_IsPrimaryAddress],
    [ContactBase].[cgi_importid],
    [ContactBase].[cgi_activated],
    [ContactBase].[cgi_addressid],
    [ContactBase].[cgi_allow_autoload],
    [ContactBase].[cgi_counterpart],
    [ContactBase].[cgi_DebtCollection],
    [ContactBase].[cgi_Max_Cards_AutoLoad],
    [ContactBase].[cgi_Membership],
    [ContactBase].[cgi_Newsletter],
    [ContactBase].[cgi_Responsibility],
    [ContactBase].[cgi_rsid],
    [ContactBase].[cgi_socialsecuritynumber],
    [ContactBase].[cgi_Representativeid],
    [ContactBase].[cgi_MyAccount],
    [ContactBase].[cgi_HasEpiserverAccount],
    [ContactBase].[cgi_MyAccount_LastLogin],
    [ContactBase].[cgi_myaccount_createdon]
from [ContactBase] 
    ...
    left join [cgi_representativeBase] [cgi_cgi_representative_contact_Representativeid] on ([ContactBase].[cgi_Representativeid] = [cgi_cgi_representative_contact_Representativeid].[cgi_representativeId])
