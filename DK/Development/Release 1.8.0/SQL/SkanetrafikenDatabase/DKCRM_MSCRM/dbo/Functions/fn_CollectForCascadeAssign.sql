...
set @l=@l+1 if(exists(select * from @t where t in(4402,4406,112,4400,1010,10027,10025,10064,1088,3,1084,2,4,9700,10014,1,1090,10000)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4210,o.OwnerId,c.o,c.t,1,@l from PhoneCall o,@t c where o.RegardingObjectId=c.o and c.t in(4402,4406,112,4400,1010,10027,10025,10064,1088,3,1084,2,4,9700,10014,1,1090,10000) end
set @l=@l+1 if(exists(select * from @t where t in(10014,1088,4,3,2,4400,1,10027,10025,112,9700,10000,1084,1090,10064,1010)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4214,o.OwnerId,c.o,c.t,1,@l from ServiceAppointment o,@t c where o.RegardingObjectId=c.o and c.t in(10014,1088,4,3,2,4400,1,10027,10025,112,9700,10000,1084,1090,10064,1010) end
set @l=@l+1 if(exists(select * from @t where t in(10064,10000,112,9700,1090,3,1084,10027,2,4,4400,10025,1010,10014,1088,4402,1)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4212,o.OwnerId,c.o,c.t,1,@l from Task o,@t c where o.RegardingObjectId=c.o and c.t in(10064,10000,112,9700,1090,3,1084,10027,2,4,4400,10025,1010,10014,1088,4402,1) end
set @l=@l+1 if(exists(select * from @t where t in(10064,1010,4406,1088,4400,4402,10027,2,1084,1090,10025,3,4,9700,112,10000,10014,1)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4207,o.OwnerId,c.o,c.t,1,@l from Letter o,@t c where o.RegardingObjectId=c.o and c.t in(10064,1010,4406,1088,4400,4402,10027,2,1084,1090,10025,3,4,9700,112,10000,10014,1) end
...
set @l=@l+1 if(exists(select * from @t where t in(4,4402,10027,112,1,10025,10000,10014,1010,4406,1088,3,1084,4700,10064,4400,9700,2,1090)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4202,o.OwnerId,c.o,c.t,1,@l from Email o,@t c where o.RegardingObjectId=c.o and c.t in(4,4402,10027,112,1,10025,10000,10014,1010,4406,1088,3,1084,4700,10064,4400,9700,2,1090) end
set @l=@l+1 if(exists(select * from @t where t in(1084,2,10000,4400,1090,9700,4,1088,10025,4402,3,10027,1010,10014,4406,10064,1,112)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4204,o.OwnerId,c.o,c.t,1,@l from Fax o,@t c where o.RegardingObjectId=c.o and c.t in(1084,2,10000,4400,1090,9700,4,1088,10025,4402,3,10027,1010,10014,4406,10064,1,112) end
set @l=@l+1 if(exists(select * from @t where t in(1090,112,1088,1084,10027,10014,10064,1010,9700,4402,4400,10025,2,1,4,10000,4406,3)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4251,o.OwnerId,c.o,c.t,1,@l from RecurringAppointmentMaster o,@t c where o.RegardingObjectId=c.o and c.t in(1090,112,1088,1084,10027,10014,10064,1010,9700,4402,4400,10025,2,1,4,10000,4406,3) end
set @l=@l+1 if(exists(select * from @t where t in(10064,1084,4400,10027,4,4406,10025,112,10014,9700,10000,4402,1090,1010,1088,2,3,1)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4201,o.OwnerId,c.o,c.t,1,@l from Appointment o,@t c where o.RegardingObjectId=c.o and c.t in(10064,1084,4400,10027,4,4406,10025,112,10014,9700,10000,4402,1090,1010,1088,2,3,1) end
...
set @l=@l+1 if(exists(select * from @t where t in(112,1088,1090,1010,1,2,4402,10027,10014,10064,10025,10000,4400,4,4406,1084,3)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,10009,o.OwnerId,c.o,c.t,1,@l from cgi_callguidefacebook o,@t c where o.RegardingObjectId=c.o and c.t in(112,1088,1090,1010,1,2,4402,10027,10014,10064,10025,10000,4400,4,4406,1084,3) end
set @l=@l+1 if(exists(select * from @t where t in(112,1088,1090,1010,1,2,4402,10027,10014,10064,10025,10000,4400,4,4406,1084,3)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,10008,o.OwnerId,c.o,c.t,1,@l from cgi_callguidechat o,@t c where o.RegardingObjectId=c.o and c.t in(112,1088,1090,1010,1,2,4402,10027,10014,10064,10025,10000,4400,4,4406,1084,3) end
set @l=@l+1 if(exists(select * from @t where t in(10064,10000,4406,4,4700,1010,10014,1090,112,10027,1,9700,1088,2,10025,3,1084)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4216,o.OwnerId,c.o,c.t,1,@l from SocialActivity o,@t c where o.RegardingObjectId=c.o and c.t in(10064,10000,4406,4,4700,1010,10014,1090,112,10027,1,9700,1088,2,10025,3,1084) end
set @l=@l+1 if(exists(select * from @t where t in(9300,4204,10000,112,4207,9605,10064,10027,1010,4202,10009,4703,4,9507,1088,9750,4209,10008,4251,1084,4414,4300,4401,4210,4201,4402,4206,4216,1,4211,10019,8181,4208,4214,4212,4400,2,10025,9606,3,9600,1090,9700)))begin insert into @t(o,t,u,q,s,y,l) select o.AnnotationId,5,o.OwnerId,c.o,c.t,1,@l from Annotation o,@t c where o.ObjectId=c.o and c.t in(9300,4204,10000,112,4207,9605,10064,10027,1010,4202,10009,4703,4,9507,1088,9750,4209,10008,4251,1084,4414,4300,4401,4210,4201,4402,4206,4216,1,4211,10019,8181,4208,4214,4212,4400,2,10025,9606,3,9600,1090,9700) end
