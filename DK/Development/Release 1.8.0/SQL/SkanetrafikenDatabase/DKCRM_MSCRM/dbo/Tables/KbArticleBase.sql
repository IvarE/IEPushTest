CREATE TABLE [dbo].[KbArticleBase] (
    ...
    [cgi_Appoval]           INT              NULL,
    [cgi_ExternalText]      NVARCHAR (MAX)   NULL,
    [cgi_PublishonWeb]      BIT              NULL,
    [cgi_IntranetIndex]     NVARCHAR (100)   NULL,
    [cgi_ExternalWebIndex]  NVARCHAR (100)   NULL,
    [cgi_devLogField]       NVARCHAR (4000)  NULL,
