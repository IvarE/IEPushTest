CREATE TABLE [dbo].[ContactBase] (
    ...
    [cgi_ContactNumber]            NVARCHAR (100)   NULL,
    [cgi_IsPrimaryAddress]         BIT              NULL,
    [cgi_importid]                 NVARCHAR (100)   NULL,
    [cgi_activated]                BIT              NULL,
    [cgi_addressid]                NVARCHAR (100)   NULL,
    [cgi_allow_autoload]           BIT              NULL,
    [cgi_counterpart]              NVARCHAR (100)   NULL,
    [cgi_DebtCollection]           BIT              NULL,
    [cgi_Max_Cards_AutoLoad]       INT              NULL,
    [cgi_Membership]               INT              NULL,
    [cgi_Newsletter]               BIT              NULL,
    [cgi_Responsibility]           NVARCHAR (100)   NULL,
    [cgi_rsid]                     NVARCHAR (100)   NULL,
    [cgi_socialsecuritynumber]     NVARCHAR (100)   NULL,
    [cgi_Representativeid]         UNIQUEIDENTIFIER NULL,
    [cgi_MyAccount]                BIT              NULL,
    [cgi_HasEpiserverAccount]      BIT              NULL,
    [cgi_MyAccount_LastLogin]      DATETIME         NULL,
    [cgi_myaccount_createdon]      DATETIME         NULL,
    ...
    CONSTRAINT [cgi_cgi_representative_contact_Representativeid] FOREIGN KEY ([cgi_Representativeid]) REFERENCES [dbo].[cgi_representativeBase] ([cgi_representativeId]) NOT FOR REPLICATION,
...
CREATE UNIQUE NONCLUSTERED INDEX [idx_cgi_contactnumber_notnull]
    ON [dbo].[ContactBase]([cgi_ContactNumber] ASC) WHERE ([cgi_contactnumber] IS NOT NULL);
