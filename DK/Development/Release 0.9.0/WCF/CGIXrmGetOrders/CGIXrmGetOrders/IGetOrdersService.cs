...
namespace CGIXrmGetOrders
{
    ...
    public interface IGetOrdersService
    {
        ...
        [OperationContract]
        GetOrderResponse GetOrders(string customerId, string orderNumber, string cardNumber, string from, string to, string email);
        ...
        [OperationContract]
        GetContactResponse GetContact(string contactid);
        */
    }
