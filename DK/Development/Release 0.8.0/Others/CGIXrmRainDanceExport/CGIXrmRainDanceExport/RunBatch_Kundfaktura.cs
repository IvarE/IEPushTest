...
namespace CGIXrmRainDanceExport
{
    public class RunBatch_Kundfaktura
    {
                            ...
                            if (_contact != null)
                            {
                                if (_incident != null)
                                {
                                    if (_invoicerecipient != null)
                                    {
                                        ...
                                        string _invoicerow = _createInvoiceRowRecord(_refund, _contact, _incident);
        ...
        //Fakturarad
        private string _createInvoiceRowRecord(refund refund, contact contact, incident incident)
        {
        ...
        private string _getxmlPendingRefunds()
        {
            ...
            //_xml += "           <condition attribute='createdon' operator='on-or-after' value='2015-09-01' />";
