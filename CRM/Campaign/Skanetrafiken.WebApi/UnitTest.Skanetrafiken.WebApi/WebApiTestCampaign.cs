...
namespace Endeavor.Crm.UnitTest
{
    ...
    public class WebApiTestCampaign : PluginFixtureBase
    {
        ...
        private readonly string TestProductNumber = "TestProduct";
        private readonly string TestProductName = "Test";
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    #region Oinloggat Köp
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            nonLoginPurchaseInfo.Source = (int)CustomerUtility.Source.OinloggatKop;
        ...
        {
            //CampaignEntity campaign = XrmRetrieveHelper.RetrieveFirst<CampaignEntity>(localContext, new ColumnSet(CampaignEntity.Fields.Name, CampaignEntity.Fields.ed_DiscountPercent, CampaignEntity.Fields.CodeName
            //                                                                                        , CampaignEntity.Fields.ed_LeadTopic, CampaignEntity.Fields.ed_LeadSource),
            //    new FilterExpression
            //    {
            //        Conditions =
            //        {
            //            new ConditionExpression(CampaignEntity.Fields.Name, ConditionOperator.Equal, CampaignName),
            //            new ConditionExpression(CampaignEntity.Fields.ed_LeadTopic, ConditionOperator.NotNull),
            //            new ConditionExpression(CampaignEntity.Fields.ed_LeadSource, ConditionOperator.NotNull)
            //        }
            //    });
