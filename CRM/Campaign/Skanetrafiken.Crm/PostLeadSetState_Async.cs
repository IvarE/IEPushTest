...
namespace Skanetrafiken.Crm
{
    public class PostLeadSetState_Async : Plugin
    {
        ...
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.SetState, LeadEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteLeadSetStateAsync)));
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.SetStateDynamicEntity, LeadEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteLeadSetStateAsync)));
