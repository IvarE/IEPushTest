...
namespace Skanetrafiken.Crm
{
    public class PreContactSetState : Plugin
    {
       ...
       // private readonly string preImageAlias = "preImage";
        ...
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PreOperation, Plugin.SdkMessageName.SetState, ContactEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteContactSetState)));
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PreOperation, Plugin.SdkMessageName.SetStateDynamicEntity, ContactEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteContactSetState)));
