...
namespace Skanetrafiken.Crm.Entities
{
    public class SynchroniseLeads : CodeActivity
    {
        ...
        public static void ExecuteCodeActivity(Plugin.LocalPluginContext localContext, EntityReference campaignId)
        {
            ...
            localContext.OrganizationService.Execute(updateLeadSourceReq);
            ...
            localContext.OrganizationService.Execute(updateTopicReq);
            ...
            string query =
                "<fetch returntotalrecordcount='true'>" +
                    ...
                    "</entity>" +
                "</fetch>";
            EntityCollection totalLeads = localContext.OrganizationService.RetrieveMultiple(new FetchExpression(query));
            CampaignEntity updateEntity = new CampaignEntity
            {
                Id = campaignId.Id,
                ed_TotalLeads = totalLeads.TotalRecordCount
            };
