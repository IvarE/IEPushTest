...
namespace Skanetrafiken.Crm.TestHelpers
{
    ...
    /// <summary>
    /// A class that provides standard setup of objects that are needed in all tests. Provides an autofixture instance that is set up to 
    /// support early bound entities, and a mock of ITracingService that does nothing (since we usually don't care about testing the content of the logs).
    /// </summary>s
