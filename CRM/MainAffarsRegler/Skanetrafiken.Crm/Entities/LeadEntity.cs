...
namespace Skanetrafiken.Crm.Entities
{
    ...
    {
        public static string CreateLead_LastNameToUseIfEmpty = "Skapa mitt konto";
        ...
        public static StatusBlock CanLeadBeCreated(Plugin.LocalPluginContext localContext, CustomerInfo customerInfo)
        {
            ...
            FilterExpression leadEmailMobileFilter = new FilterExpression(LogicalOperator.And);
            leadEmailMobileFilter.AddCondition(LeadEntity.Fields.StateCode, ConditionOperator.Equal, (int)Generated.LeadState.Open);
            leadEmailMobileFilter.AddCondition(LeadEntity.Fields.EMailAddress1, ConditionOperator.Equal, customerInfo.Email);
            leadEmailMobileFilter.AddCondition(LeadEntity.Fields.MobilePhone, ConditionOperator.Equal, customerInfo.Mobile);

            IList<LeadEntity> existingConflictingLeads = XrmRetrieveHelper.RetrieveMultiple<LeadEntity>(
                localContext, 
                LeadInfoBlock, 
                leadEmailMobileFilter);
        ...
        public CustomerInfo ToCustomerInfo(Plugin.LocalPluginContext localContext)
        {
            ...
            // Workaround-lastname should not be returned!
            if (LeadEntity.CreateLead_LastNameToUseIfEmpty.Equals(customerInfo.LastName))
        ...
        public static LeadEntity CreateLead(Plugin.LocalPluginContext localContext, CustomerInfo customerInfo, string LeadSubject, CampaignEntity campaign = null)
        {
            ...
            {
                // Make sure campaign record is active.
