    ...
    public class MergeRecordsFixture : PluginFixtureBase
    {
        ...
        public void MergeContacts()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                ContactEntity fromContact = ContactFixture.CreateUnitTestContact(localContext, Generated.ed_informationsource.SkapaMittKonto);

                // Create second contact
                ContactEntity toContact = ContactFixture.CreateUnitTestContact(localContext,Generated.ed_informationsource.SkapaMittKonto);
