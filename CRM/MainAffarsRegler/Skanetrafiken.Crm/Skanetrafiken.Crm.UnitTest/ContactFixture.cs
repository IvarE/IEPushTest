    ...
    public class ContactFixture : PluginFixtureBase
    {
        ...
        public void Contact_CreateUnittestContact()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                ContactEntity contact = ContactFixture.BuildUnitTestContactNoCreate(localContext, Generated.ed_informationsource.SkapaMittKonto);
        ...
        /// <summary>
        /// Test AdminSkapaKund with minimized info
        /// </summary>
        [Test, Category("Regression")]
        ...
        public void PreContactSetStateTest()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                ContactEntity.HandlePreContacSetState(localContext, preImage.ToEntityReference());
        ...
        public void PreContactPluginTest()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    contact = BuildUnitTestContactNoCreate(localContext, Generated.ed_informationsource.AdmSkapaKund);
                    contact.HandlePreContactCreate(localContext);
                    ...
                    NUnit.Framework.Assert.False(exception);    // We are now not getting any conflict. 
                    exception = false;
                    #endregion
                    ...
                    ContactEntity preImage = BuildUnitTestContactNoCreate(localContext, DateTime.Now.AddMonths(-5), Generated.ed_informationsource.AdmAndraKund);
                    ...
                    NUnit.Framework.Assert.False(exception);
                    exception = false;
                    #endregion
        ...
        /// <returns></returns>
        public static ContactEntity BuildUnitTestContactNoCreate(Plugin.LocalPluginContext localContext, DateTime dateTime, Generated.ed_informationsource source)
        {
            if (source == Generated.ed_informationsource.SkapaMittKonto
                || source == Generated.ed_informationsource.UppdateraMittKonto)
            {
        ...
        /// <param name="localContext"></param>
        /// <returns></returns>
        public static ContactEntity BuildUnitTestContactNoCreate(Plugin.LocalPluginContext localContext, Generated.ed_informationsource source)
        {
            return BuildUnitTestContactNoCreate(localContext, DateTime.Now, source);
        }
        ...
        #region NewContactmatchWithCompanyRole from Merge
        //[Test, Explicit, Category("Debug")]
        //public void NewContactMatchWithCompanyRole()
        //{
        ...
        //        List<CompanyRoleEntity> allCompanyRoles = XrmRetrieveHelper.RetrieveMultiple<CompanyRoleEntity>(localContext, new ColumnSet(true), getCompanyRole).ToList();
        ...
        //                if (!string.IsNullOrWhiteSpace(coRole.ed_EmailAddress) && !string.IsNullOrWhiteSpace(coRole.ed_Telephone))
        //                {
        //                    //Make sure we found contact and account
        //                    if (coContact != null && coAccount != null)
        //                    {
        //                        //Compare Email1/Email2 + Telephone to cRole_Email + cRole_Telephone
        //                        if ((!string.IsNullOrWhiteSpace(coContact.EMailAddress1) || !string.IsNullOrWhiteSpace(coContact.EMailAddress2)) && !string.IsNullOrWhiteSpace(coContact.Telephone2))
        //                        {
        //                            //Handle telephone prefixes (0046/+46/00...)
        //                            var contact_Telephone = coContact.Telephone2.Substring(coContact.Telephone2.Length - 9, 9);
        //                            var coRole_Telephone = coRole.ed_Telephone.Substring(coRole.ed_Telephone.Length - 9, 9);

        //                            //Check if related contacts data (email + telephone) matches with CompanyRoles data (email + telephone), if not... enter.
        ...
        //                                string.Compare(contact_Telephone, coRole_Telephone) != 0)
        //                            {
        ...
        //                                #region Telephone Filter (phoneNrFilter)
        ...
        //                                phoneNrFilter.AddCondition(ContactEntity.Fields.Telephone2, ConditionOperator.EndsWith, coRole_Telephone);
        ...
        //                                if (emMoContacts.Count == 1) //Found exactly 1 contact
        //                                {
        //                                    //Found Contact, update CompanyRole with new Contact (maybe do something wïth the previous contact that is being replaced)
        ...
        //                                    //Check if association aldready exists
        ...
        //                                    //If there is no association to the accounts, create an association
        //                                    if (!DoesRelationshipExist(localContext, "cgi_account_contact", AccountEntity.EntityLogicalName, coAccount.AccountId.Value, ContactEntity.EntityLogicalName, newContact.ContactId.Value))
        //                                    {
        //                                        #region AssociateEntities request
        ...
        //                                    }
        //                                    //Type of contact - AccountRoleCode (portaladministratör = value 8)
        //                                    newContact.AccountRoleCode = Generated.contact_accountrolecode.PortalAdministrator; //Set role to admin. Search for OptionSet value
                    ...
                    foreach (CompanyRoleEntity coRole in allCompanyRoles)
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(coRole.ed_EmailAddress) && !string.IsNullOrWhiteSpace(coRole.ed_Telephone))
                        {
                            ...
                            if (coContact != null && coAccount != null)
                            {
                                ...
                                if ((!string.IsNullOrWhiteSpace(coContact.EMailAddress1) || !string.IsNullOrWhiteSpace(coContact.EMailAddress2)) && !string.IsNullOrWhiteSpace(coContact.Telephone2))
                                {
                                        ...
                                        string.Compare(contact_Telephone, coRole_Telephone) != 0)
                                    {
                                        ...
                                        if (emMoContacts.Count == 1) //Found exactly 1 contact
                                        {
                                            ...
                                            #region Handle Name For CompanyRole and Contact
                                            ...
                                            //    // Compare first- and lastname
                                            //    if (String.Compare(firstnameNewContact, firstnameCoRole, CultureInfo.CreateSpecificCulture("sv-SE"), CompareOptions.IgnoreNonSpace | CompareOptions.IgnoreCase) != 0
                                            //        || String.Compare(lastnameNewContact, lastnameCoRole, CultureInfo.CreateSpecificCulture("sv-SE"), CompareOptions.IgnoreNonSpace | CompareOptions.IgnoreCase) != 0)
                                            //    {
                                            //        uppCompanyRole.ed_FirstName = newContact.FirstName;
                                            //        uppCompanyRole.ed_LastName = newContact.LastName;
                                            //    }
                                            //}
                                            //Handle more name scenarios
                                            //Dont update anything if there is no name on the CompanyRole before we change contact
                                            ...
                                            ContactEntity uppdateContact = new ContactEntity();
                                            uppdateContact.Id = newContact.Id;
                                            uppdateContact.AccountRoleCode = Generated.contact_accountrolecode.PortalAdministrator;//Set role to admin. Search for OptionSet value

                                            if (!string.IsNullOrWhiteSpace(coRole.ed_SocialSecurityNumber))// Handle Social Security Block?
                                            {
                                                uppdateContact.ed_SocialSecurityNumberBlock = coRole.ed_SocialSecurityNumber;
                                            }
                                            XrmHelper.Update(localContext, uppdateContact);
                                            ...
                                            //Remove/Indicate that the prevoious contact has lost its connection to CompanyRole (also account?)
                                            DisassociateEntities(localContext, "cgi_account_contact", AccountEntity.EntityLogicalName, coAccount.Id, ContactEntity.EntityLogicalName, coContact.Id, false);

                                        }
                                        else if (emMoContacts.Count > 1) // Found more than 1: Connect with the latest created contact if we find mor than 1 contact
                                        {
                                            //Find the contact with the latest created on
                                            newContact = emMoContacts.Where(i => i.CreatedOn == emMoContacts.Max(x => x.CreatedOn)).FirstOrDefault();

                                            //use this contact to update CompanyRole
                                            uppCompanyRole.Id = coRole.Id;
                                            uppCompanyRole.ed_Contact = newContact.ToEntityReference();

                                            //Add handling for name between CompanyRole and Contact
                                        ...
                                        else if (emMoContacts.Count == 0) //Did not find any contact: Create new
                                        {
                                            ...
                                            //Create a new contact and place it in the company role
                                            newContact.EMailAddress1 = coRole.ed_EmailAddress;
                                            newContact.Telephone2 = coRole.ed_Telephone;
                                            ...
                                            var newCreatedContact = XrmHelper.Create(localContext, newContact);
                                    ...
                                    {
                                        //2. Uppdatera kontakt med rollen Administratör
                                        #region UpdateContact with information from CompanyRole
                                ...
                                }//What to do if the found contat has null email / telephone
                            } // What to do if contact or account is null
                        } //What to do if companyRole Email/Telephone is null
                    }
                }
