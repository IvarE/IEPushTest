...
{
    public class PreKBArticleUpdate_Sync : Plugin
    {
        public PreKBArticleUpdate_Sync()
            : base(typeof(PreKBArticleUpdate_Sync))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PreOperation, Plugin.SdkMessageName.Update, KBArticleEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteKBArticleUpdateSync)));
        ...
        /// </remarks>
        protected void PreExecuteKBArticleUpdateSync(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                KBArticleEntity target = ((Entity)localContext.PluginExecutionContext.InputParameters["Target"]).ToEntity<KBArticleEntity>();
