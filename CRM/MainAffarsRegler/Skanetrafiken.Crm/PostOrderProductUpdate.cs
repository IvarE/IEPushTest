...
namespace Skanetrafiken.Crm
{
    public class PostOrderProductUpdate : Plugin
    {
        ...
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Update, OrderProductEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteOrderProductUpdate)));
