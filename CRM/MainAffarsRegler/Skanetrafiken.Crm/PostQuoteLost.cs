...
{
    public class PostQuoteLost : Plugin
    {
        /// <summary>
        /// </summary>
        ...
        /// </remarks>
        protected void PostExecuteQuoteLost(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                try
                {
                    ...
                    QuoteEntity.HandleQuoteEntityLost(localContext, target);
                }
                catch (Exception ex)
                {
