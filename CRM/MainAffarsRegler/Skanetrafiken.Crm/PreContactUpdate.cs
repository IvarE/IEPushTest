...
namespace Skanetrafiken.Crm
{
    public class PreContactUpdate : Plugin
    {
        ...
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(20, "Update", ContactEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteContactUpdate)));
        ...
        /// </remarks>
        protected void PreExecuteContactUpdate(LocalPluginContext localContext)
        {
