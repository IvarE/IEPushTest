...
{
    public class PostTicketInfoCreate : Plugin
    {
        /// <summary>
        /// </summary>
        public PostTicketInfoCreate()
            : base(typeof(PostTicketInfoCreate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Create, TicketInfoEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteTicketInfoCreate)));
        ...
        /// </remarks>
        protected void PostExecuteTicketInfoCreate(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                try
                {
                    ...
                    TicketInfoEntity.HandlePostTicketInfoEntityCreate(localContext, target);
                }
                catch (Exception ex)
                {
