...
{
    public class PostTicketInfoUpdate : Plugin
    {

        private readonly string preImageAlias = "preImage";

        public PostTicketInfoUpdate()
            : base(typeof(PostTicketInfoUpdate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Update, TicketInfoEntity.EntityLogicalName, new Action<LocalPluginContext>(Execute)));
