...
{
    public class PostSlotCreate_Async : Plugin
    {
        public PostSlotCreate_Async()
               : base(typeof(PostSlotCreate_Async))
        {
        ...
        protected void Execute(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                try
                {
                    ...
                    SlotsEntity.HandleSlotsEntityCreateAsync(localContext, target);
                }
                catch (Exception ex)
                {
