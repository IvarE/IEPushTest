...
if (typeof (Endeavor.Skanetrafiken.TextMessage) == "undefined") {
    Endeavor.Skanetrafiken.TextMessage = {
        SaveAndSend: function () {
            debugger;
            Xrm.Page.data.save().then(Endeavor.Skanetrafiken.TextMessage.SendSMS, Endeavor.Skanetrafiken.TextMessage.ErrorOnSave);
        },
        SendSMS: function () {
            debugger;
            Xrm.Page.ui.setFormNotification("Sending Text Message. Please Wait.", "INFO", "SendSMSNotification");
            Process.callAction("ed_SendTextMessage",
                [{
                    key: "Target",
                    type: Process.Type.EntityReference,
                    value: new Process.EntityReference("ed_textmessage", Xrm.Page.data.entity.getId())
                }],
                function () {
                    Xrm.Page.data.refresh();
                    Xrm.Page.ui.setFormNotification("Text Message successfully delivered.", "INFO", "SendSMSNotification");
                },
                function (e, t) {
                    // Error
                    Xrm.Page.ui.setFormNotification("Something went wrong: " + e, "INFO", "SendSMSNotification");
        ...
        ErrorOnSave: function (error) {
            debugger;
            Xrm.Page.ui.setFormNotification("Error on save: " + error);
        }
    }   
}
