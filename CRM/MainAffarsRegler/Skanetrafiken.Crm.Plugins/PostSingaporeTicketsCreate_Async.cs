...
namespace Skanetrafiken.Crm.Plugins
{
    public class PostSingaporeTicketsCreate_Async : Plugin
    {
        public PostSingaporeTicketsCreate_Async() : base(typeof(PostSingaporeTicketsCreate_Async))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Create, SingaporeTicketEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteSingaporeTicketCreateAsync)));
        ...
        /// </remarks>
        protected void PostExecuteSingaporeTicketCreateAsync(LocalPluginContext localContext)
        {
