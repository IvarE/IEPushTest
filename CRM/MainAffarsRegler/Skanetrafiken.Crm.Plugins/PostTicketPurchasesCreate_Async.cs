...
{
    public class PostTicketPurchasesCreate_Async : Plugin
    {
        public PostTicketPurchasesCreate_Async() : base(typeof(PostTicketPurchasesCreate_Async))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Create, TicketInfoEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteTicketPurchasesCreateSync)));
        ...
        /// </remarks>
        protected void PostExecuteTicketPurchasesCreateSync(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    target.HandlePostTicketPurchasesCreateAsync(localContext);
                }
                catch (Exception ex)
                {
