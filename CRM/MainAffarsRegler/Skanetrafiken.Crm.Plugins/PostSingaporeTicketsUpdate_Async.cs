...
{
    public class PostSingaporeTicketsUpdate_Async : Plugin
    {
        string preImageAlias = "preImage";
        public PostSingaporeTicketsUpdate_Async() : base(typeof(PostSingaporeTicketsUpdate_Async))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Update, SingaporeTicketEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteSingaporeTicketUpdateAsync)));
        ...
        /// </remarks>
        protected void PostExecuteSingaporeTicketUpdateAsync(LocalPluginContext localContext)
        {
