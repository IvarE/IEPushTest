...
{
    public class PostTicketPurchasesUpdate_Async : Plugin
    {
        string preImageAlias = "preImage";
        public PostTicketPurchasesUpdate_Async() : base(typeof(PostTicketPurchasesUpdate_Async))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Update, TicketInfoEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteTicketPurchasesUpdateSync)));
        ...
        /// </remarks>
        protected void PostExecuteTicketPurchasesUpdateSync(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    target.HandlePostTicketPurchasesUpdateAsync(localContext, preImage);
                }
                catch (Exception ex)
                {
