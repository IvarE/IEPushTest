...
{
    public class PreValueCodeTemplateCreate : Plugin
    {
        public PreValueCodeTemplateCreate()
            : base(typeof(PreValueCodeTemplateCreate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(20, "Create", ValueCodeTemplateEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteValueCodeTemplateCreate)));
        ...
        /// </remarks>
        protected void PreExecuteValueCodeTemplateCreate(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    target.SetTemplateNumber(localContext, null);
                }
                catch (Exception ex)
                {
