...
{
    public class PostQualifyLead_Async : Plugin
    {
        /// <summary>
        /// </summary>
        private readonly string preImageAlias = "preImage";

        public PostQualifyLead_Async()
            : base(typeof(PostQualifyLead_Async))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(
                ...
                new Action<LocalPluginContext>(PostExecuteQualityLeadAsync)));
        ...
        /// </remarks>
        protected void PostExecuteQualityLeadAsync(LocalPluginContext localContext)
        {
            ...
            try
            {
                LeadEntity.HandlePostLeadSetStateAsync(localContext, leadid, new OptionSetValue((int)Generated.LeadState.Qualified), new OptionSetValue((int)Generated.lead_statuscode.Qualified));
            }
            catch (Exception ex)
            {
