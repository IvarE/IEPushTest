    ...
    public class PreLeadCreate : Plugin
    {
            ...
            : base(typeof(PreLeadCreate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(
                ...
                new Action<LocalPluginContext>(PreExecuteLeadCreate)));
        ...
        /// </remarks>
        protected void PreExecuteLeadCreate(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    target.HandlePreLeadCreate(localContext);
                }
                catch (Exception ex)
                {
