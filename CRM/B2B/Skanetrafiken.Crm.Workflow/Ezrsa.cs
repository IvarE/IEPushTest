...
public HASH_ALGORITHM MapHashAlgorithmOID (string hash_algorithm_oid)
{
    ...
    else if (String.Compare (hash_algorithm_oid, CryptoConfig.MapNameToOID ("SHA256"), true) == 0)
        ha = EZRSA.HASH_ALGORITHM.RSA_SHA256;
    else
...
HASH_ALGORITHM map_hash_algorithm (HashAlgorithm hasher)
{
    ...
    if (Object.ReferenceEquals (t, typeof (SHA256Managed)))
