...
{
    public class PreCampaignResponseCreate : Plugin
    {
        public PreCampaignResponseCreate()
            : base(typeof(PreCampaignResponseCreate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(20, "Create", CampaignResponseEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteCampaignResponseCreate)));
        ...
        /// </remarks>
        protected void PreExecuteCampaignResponseCreate(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    target.HandlePreCampaignResponseCreate(localContext);
                }
                catch (Exception ex)
                {
