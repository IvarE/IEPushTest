...
{
    public class PreValidationContactDelete : Plugin
    {
        /// <summary>
        /// </summary>
        private readonly string preImageAlias = "preImage";
         
        public PreValidationContactDelete()
            : base(typeof(PreValidationContactDelete))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PreValidation, Plugin.SdkMessageName.Delete, ContactEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteContactDelete)));
        ...
        /// </remarks>
        protected void PreExecuteContactDelete(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is EntityReference)
            {
                ...
                try
                {
                    preImage.HandlePreValidationContactDelete(localContext);
                }
                catch (Exception ex)
                {
