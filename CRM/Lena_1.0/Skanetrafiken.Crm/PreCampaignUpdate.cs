...
{
    public class PreCampaignUpdate : Plugin
    {
        /// <summary>
        /// </summary>
        private readonly string preImageAlias = "preImage";

        public PreCampaignUpdate()
            : base(typeof(PreCampaignUpdate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(20, "Update", CampaignEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteCampaignUpdate)));
        ...
        /// </remarks>
        protected void PreExecuteCampaignUpdate(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    target.HandlePreCampaignUpdate(localContext, preImage);
                }
                catch (Exception ex)
                {
