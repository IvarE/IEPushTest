...
{
    public class PreCampaignResponseUpdate : Plugin
    {
        /// <summary>
        /// </summary>
        private readonly string preImageAlias = "preImage";

        public PreCampaignResponseUpdate()
            : base(typeof(PreCampaignResponseUpdate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(20, "Update", CampaignResponseEntity.EntityLogicalName, new Action<LocalPluginContext>(PreExecuteCampaignResponseUpdate)));
        ...
        /// </remarks>
        protected void PreExecuteCampaignResponseUpdate(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    target.HandlePreCampaignResponseUpdate(localContext);
                }
                catch (Exception ex)
                {
