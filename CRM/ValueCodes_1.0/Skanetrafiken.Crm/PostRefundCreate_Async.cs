...
{
    //public class PostRefundCreate_Async : Plugin
    //{
    //    public PostRefundCreate_Async()
    //        : base(typeof(PostRefundCreate_Async))
    //    {
    //        base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Create, RefundEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteRefundCreateAsync)));
    ...
    //    /// </remarks>
    //    protected void PostExecuteRefundCreateAsync(LocalPluginContext localContext)
    //    {
    ...
    //            RefundEntity target = ((Entity)localContext.PluginExecutionContext.InputParameters["Target"]).ToEntity<RefundEntity>();

    //            try
    //            {
    //               target.HandlePostRefundCreateAsync(localContext);
    //            }
    //            catch (Exception ex)
    //            {
