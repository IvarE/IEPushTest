...
{
    public class PostContactCreate_Async : Plugin
    {
        public PostContactCreate_Async()
            : base(typeof(PostContactCreate_Async))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>((int)Plugin.SdkMessageProcessingStepStage.PostOperation, Plugin.SdkMessageName.Create, ContactEntity.EntityLogicalName, new Action<LocalPluginContext>(PostExecuteContactCreateAsync)));
        ...
        /// </remarks>
        protected void PostExecuteContactCreateAsync(LocalPluginContext localContext)
        {
                ...
                localContext.PluginExecutionContext.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    target.HandlePostContactCreateAsync(localContext);
                }
                catch (Exception ex)
                {
