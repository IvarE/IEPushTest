...
namespace Endeavor.Crm.DeltabatchService
{
    ...
    public class DownloadJob : IJob
    {
        ...
        private ContactEntity ParseChangedFieldsToAlteredContactEntity(Plugin.LocalPluginContext localContext, string[] lineParams, ref DeltabatchLogEntity deltaLog, ref bool update, ref bool rejected)
        {
            ...
            #endregion
            #region City
            if (String.IsNullOrEmpty(city) && !String.IsNullOrEmpty(existingContact.Address1_City) && existingContact.Address1_City != "Ort")
            {
                updateContact.Address1_City = "Ort";
                update = true;
            }
            else if (String.IsNullOrEmpty(city) && String.IsNullOrEmpty(existingContact.Address1_City))
            {
                updateContact.Address1_City = "Ort";
                update = true;
            }
            else if (existingContact.Address1_City != city)
            {
