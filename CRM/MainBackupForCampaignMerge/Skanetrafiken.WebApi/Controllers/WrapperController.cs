...
namespace Skanetrafiken.Crm.Controllers
{
    public class WrapperController : ApiController
    {
        ...
        public HttpResponseMessage VerifyMyAccountToken(string id = null)
        {
            ...
            if (!(this.Request.Headers.Contains(MKLHeaderName) || this.Request.Headers.Contains(InternalHeaderName)))
            {
                HttpResponseMessage hdrResp = new HttpResponseMessage(HttpStatusCode.BadRequest);
                hdrResp.Content = new StringContent(string.Format(Resources.TokenHeaderMissing, MKLHeaderName, InternalHeaderName));
                return hdrResp;
            }
        ...
        public static void FormatCustomerInfo(ref CustomerInfo customerInfo)
        {
            if (customerInfo != null){
                ...
                {
                    customerInfo.AddressBlock.CO = ContactEntity.Capitalise(customerInfo.AddressBlock.CO);
