    ...
    public class WebApiTest : PluginFixtureBase
    {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
...

                    {
                        ...
                        string url = $"{WebApiTestHelper.WebApiRootEndpoint}leads/5b6f577d-14ef-447d-99e1-f4c8485b808a";
                        //string url = string.Format(@"{0}{1}", WebApiTestHelper.WebApiRootEndpoint, "contacts");
                        var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
                        this.CreateTokenForTest(localContext, httpWebRequest, new Guid("7a621f88-9a51-e711-80e3-0050569071be"));
                        httpWebRequest.ContentType = "application/json";
                        httpWebRequest.Method = "PUT";

                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, new CustomerInfo()
                            {
                                Guid = "7a621f88-9a51-e711-80e3-0050569071be",
                                MklId = "1870559",
                                Source = (int)CustomerUtility.Source.ValideraEpost
                            });
        ...
        public void ValidateEmailWithConflicts()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    this.CreateTokenForTest(localContext, httpWebRequestConflict);
                    ...
                    {
                        string InputJSON = SerializeCustomerInfo(localContext, contact2);
                        streamWriter.Write(InputJSON);
                        streamWriter.Flush();
                        streamWriter.Close();
                    }
                    ...
                    using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                    {
                        string InputJSON = SerializeCustomerInfo(localContext, fullInfo);
                        streamWriter.Write(InputJSON);
                        streamWriter.Flush();
                        streamWriter.Close();
                    }
                    ...
                    #region Hämta LatestLinkGuid Lead
                    {
                        ...
                        this.CreateTokenForTest(localContext, httpWebRequestLink);
                    ...
                    #region Validate Conflict Lead
                    {
                        ...
                        this.CreateTokenForTest(localContext, httpWebRequestValidate, new Guid(leadGuid));
        ...
        public void WebApiLoadTest()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                {
                    LoadTest lt = new LoadTest(localContext, $"#{i}");
                    Thread thread = new Thread(new ThreadStart(lt.Test));
        ...
        private class LoadTest : PluginFixtureBase
        {
            ...
            public LoadTest(Plugin.LocalPluginContext lc, string name)
            {
                localContext = lc;
                threadName = name;
            }
            ...
            public void Test()
            {
                try
                {
                    ...
                    for (int i = 0; i < rounds; i++)
                    {
                        ...
                        var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
                        this.CreateTokenForTest(localContext, httpWebRequest, guid); // GET Contact
                        //this.CreateTokenForTest(localContext, httpWebRequest); // ping
                        httpWebRequest.ContentType = "application/json";
                        httpWebRequest.Method = "GET";
                ...
                try
                {
                    ...
                    try
                    {
                        CustomerInfo correctInfo = new CustomerInfo
                        {
                            ...
                            Source = (int)CustomerUtility.Source.UppdateraMittKonto,
                        ...
                        this.CreateTokenForTest(localContext, httpWebRequest, Guid.Parse(correctInfo.Guid));
                        httpWebRequest.ContentType = "application/json";
                        httpWebRequest.Method = "PUT";
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, correctInfo);
                            streamWriter.Write(InputJSON);
                            streamWriter.Flush();
                            streamWriter.Close();
                        }
                    ...
                    try
                    {
                        ...
                        var httpWebRequest = (HttpWebRequest)WebRequest.Create($"{WebApiTestHelper.WebApiRootEndpoint}contacts/{correctInfo.Guid}");
                        this.CreateTokenForTest(localContext, httpWebRequest, Guid.Parse(Guid.NewGuid().ToString()));
                        httpWebRequest.ContentType = "application/json";
                        httpWebRequest.Method = "PUT";
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    try
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, badInfo);
                            streamWriter.Write(InputJSON);
                            streamWriter.Flush();
                            streamWriter.Close();
                        }
                    ...
                    try
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, badinfo2);
                            streamWriter.Write(InputJSON);
                            streamWriter.Flush();
                            streamWriter.Close();
                        }
                    ...
                    try
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, badinfo3);
                            streamWriter.Write(InputJSON);
                            streamWriter.Flush();
                            streamWriter.Close();
                        }
        ...
        public void AllowDuplicateBirthDates()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                    {
                        string InputJSON = SerializeCustomerInfo(localContext, goodInfo1);
                        streamWriter.Write(InputJSON);
                        streamWriter.Flush();
                        streamWriter.Close();
                    }
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    #region ÄndraKunduppgifter
                    {
                        ...
                        var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
                        this.CreateTokenForTest(localContext, httpWebRequest, updateExistingContact.ContactId);
                        httpWebRequest.ContentType = "application/json";
                        httpWebRequest.Method = "PUT";

                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, updateInfo);
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    if (testContact != null)
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, rgolInfo);
                            streamWriter.Write(InputJSON);
                            streamWriter.Flush();
                            streamWriter.Close();
                        }
        ...
        public void PassTest()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    using (var streamWriter = new StreamWriter(httpWebRequest1.GetRequestStream()))
                    {
                        string InputJSON = SerializeCustomerInfo(localContext, passInfo);
                        streamWriter.Write(InputJSON);
                        streamWriter.Flush();
                        streamWriter.Close();
                    }
                    ...
                    this.CreateTokenForTest(localContext, httpWebRequestMin);
                    ...
                    try
                    {
                        ...
                        this.CreateTokenForTest(localContext, httpWebRequestInvSource);
                        ...
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, invalidPassSourceInfo);
                            streamWriter.Write(InputJSON);
                            streamWriter.Flush();
                            streamWriter.Close();
                        }
                    ...
                    try
                    {
                        CustomerInfo invalidPassInfo = new CustomerInfo
                        {
                            FirstName = "PassFirstNameTest",
                            Email = $"pass.TestMail{testInstanceName}@mail.pass",
                            Source = (int)CustomerUtility.Source.PASS
                        };
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, invalidPassInfo);
                            streamWriter.Write(InputJSON);
                            streamWriter.Flush();
                            streamWriter.Close();
                        }
        ...
        public void MergeAfterEmailChangeTest()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    this.CreateTokenForTest(localContext, httpWebRequestChangeEmail);
                    ...
                    {
                        string InputJSON = SerializeCustomerInfo(localContext, unvalidatedEmail1WithPhoneNumber);
                    ...
                    #region SkapaKontoLead
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            validatedEmail2WithoutPhoneNumber.Source = (int)CustomerUtility.Source.SkapaMittKonto;
                            string InputJSON = SerializeCustomerInfo(localContext, validatedEmail2WithoutPhoneNumber);
                    ...
                    #region ValideraEmailSkapaKund
                    {
                        ...
                        string url = $"{WebApiTestHelper.WebApiRootEndpoint}leads/{linkGuid}";
                        var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
                        this.CreateTokenForTest(localContext, httpWebRequest, new Guid(guid2));
                        httpWebRequest.ContentType = "application/json";
                        httpWebRequest.Method = "PUT";
                    ...
                    #region ÄndraEpost
                    {
                        ...
                        validatedEmail2WithoutPhoneNumber.Source = (int)CustomerUtility.Source.BytEpost;
                        ...
                        this.CreateTokenForTest(localContext, httpWebRequest, new Guid(validatedEmail2WithoutPhoneNumber.Guid));
                        httpWebRequest.ContentType = "application/json";
                        httpWebRequest.Method = "PUT";
                    ...
                    #region ValideraÄndradEpost
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            string InputJSON = SerializeCustomerInfo(localContext, validateChangedEmail);
        ...
        public void AngeNamnTest()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                string testInstanceName = "1"+CustomerUtility.GetUnitTestID().Substring(1);
                ...
                try
                {
                    ...
                    **/
                    ...
                    this.CreateTokenForTest(localContext, httpWebRequestAngeNamn);
                    ...
                    {
                        customer.Source = (int)CustomerUtility.Source.OinloggatLaddaKort;
                        string InputJSON = SerializeCustomerInfo(localContext, angeNamnContactInfo);
                    ...
                    **/
                    ...
                    using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                    {
                        customer.Source = (int)CustomerUtility.Source.OinloggatKop;
                        string InputJSON = SerializeCustomerInfo(localContext, customer);
        ...
        public void RgolTest()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    this.CreateTokenForTest(localContext, httpWebRequestMailOnly);
                    ...
                    {
                        string InputJSON = SerializeCustomerInfo(localContext, rgolInfoMailOnly);
                        streamWriter.Write(InputJSON);
                        streamWriter.Flush();
                        streamWriter.Close();
                    }
                    ...
                    this.CreateTokenForTest(localContext, httpWebRequestMailOnly2);
                    ...
                    this.CreateTokenForTest(localContext, httpWebRequestSocSecOnly);
                    ...
                    {
                        string InputJSON = SerializeCustomerInfo(localContext, rgolInfoSocSecOnly);
                        streamWriter.Write(InputJSON);
                        streamWriter.Flush();
                        streamWriter.Close();
                    }
                    ...
                    this.CreateTokenForTest(localContext, httpWebRequestSocSecOnly2);
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                try
                {
                    ...
                    #region ValideraEmailSkapaKund
                    {
                        ...
                        string url = $"{WebApiTestHelper.WebApiRootEndpoint}leads/{linkGuid}";
                        var httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
                        this.CreateTokenForTest(localContext, httpWebRequest, customerId);
                        httpWebRequest.ContentType = "application/json";
                        httpWebRequest.Method = "PUT";
                    ...
                    #region ÄndraKunduppgifter
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            ...
                            customerUpdateInfo.Source = (int)CustomerUtility.Source.UppdateraMittKonto;
                            string InputJSON = SerializeCustomerInfo(localContext, customerUpdateInfo);
                    ...
                    #region ÄndraEpost
                    {
                        ...
                        customerUpdateInfo.Source = (int)CustomerUtility.Source.BytEpost;
                    ...
                    #region OinloggatKöp Existerande Kund
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            customerUpdateInfo.Source = (int)CustomerUtility.Source.OinloggatKop;
        ...
        private CustomerInfo ValidCustomerInfo_FullTest(string testInstanceName, string personnummer = null)
        {
