...
namespace Endeavor.Crm
{
    ...
    public static class XrmHelper
    {
        ...
        public static Guid Create(Plugin.LocalPluginContext context, Entity de)
        {
            ...
            CreateResponse response = (CreateResponse)context.OrganizationService.Execute(request);
            return response.id;
        }
        ...
        public static void Update(IOrganizationService service, Entity de)
        {
        ...
        /// <param name="context">Plugin context</param>
        /// <param name="de">Target record, with the updated values</param>
        public static void Update(Plugin.LocalPluginContext context, Entity de)
        {
            UpdateRequest request = new UpdateRequest();
            request.Target = de;

            UpdateResponse response = (UpdateResponse)context.OrganizationService.Execute(request);
        }
        ...
        public static void Delete(IOrganizationService service, EntityReference target)
        {
            DeleteRequest request = new DeleteRequest();
            request.Target = target;

            DeleteResponse response = (DeleteResponse)service.Execute(request);
        }
        ...
        /// <param name="context">Plugin context</param>
        /// <param name="target">Target record</param>
        public static void Delete(Plugin.LocalPluginContext context, EntityReference target)
        {
            DeleteRequest request = new DeleteRequest();
            request.Target = target;

            DeleteResponse response = (DeleteResponse)context.OrganizationService.Execute(request);
        }
        ...
        public static Entity Retrieve(Plugin.LocalPluginContext context, string entity, Guid id, ColumnSet columns)
        {
            ...
            RetrieveResponse response = (RetrieveResponse)context.OrganizationService.Execute(request);
            return response.Entity;
        }
        ...
        public static Entity RetrieveFirst(Plugin.LocalPluginContext context, string entity, ColumnSet columns, FilterExpression filter = null, Dictionary<string, OrderType> orderby = null)
        {
            ...
            EntityCollection result = context.OrganizationService.RetrieveMultiple(query);
        ...
        public static List<Entity> RetrieveMultiple(Plugin.LocalPluginContext context, string entity, ColumnSet columns, FilterExpression filter = null)
        {
            ...
            return RetrieveMultiple(context, query, page);
        }
        ...
        public static Int32 RetrieveRecordCount(Plugin.LocalPluginContext context, String entity, FilterExpression filter = null)
        {
            ...
            return RetrieveMultiple(context, query).Count;
        }
        ...
        public static List<Entity> RetrieveMultiple(Plugin.LocalPluginContext context, QueryExpression query, PagingInfo page = null)
        {
            ...
            do
            {
                ...
                response = (RetrieveMultipleResponse)context.OrganizationService.Execute(request);
        ...
        public static List<string> RetrieveEntityAttributeNames(Plugin.LocalPluginContext context, string entity, bool onlyValidForAdvancedFind = true)
        {
            ...
            RetrieveEntityResponse response = (RetrieveEntityResponse)context.OrganizationService.Execute(request);
        ...
        {
            // Create the E-mail
            Guid id = context.OrganizationService.Create(email);
            ...
            if (IssueSend)
            {
                ...
                SendEmailResponse response = (SendEmailResponse)context.OrganizationService.Execute(request);
            }
            return id;
        }
