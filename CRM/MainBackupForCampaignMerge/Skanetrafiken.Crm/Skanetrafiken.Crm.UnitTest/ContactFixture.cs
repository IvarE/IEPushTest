    ...
    public class ContactFixture : PluginFixtureBase
    {
        ...
        public void Contact_Util()
        {
            ...
            using (_serviceProxy = ServerConnection.GetOrganizationProxy(Config))
            {
                ...
                c1.CombineAttributes(c2);

                //string DiscoverServiceURL = "http://v-dkcrm-tst/XRMServices/2011/Discovery.svc";
                ...
                //    RetrieveOrganizationsResponse retrieveOrganizationsResponse = (RetrieveOrganizationsResponse)discoveryProxy.Execute(retrieveOrganizationsRequest);
